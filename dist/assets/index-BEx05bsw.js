...
`;function vt(e,t,n){let r=new me;r.moveTo(e[0].x,e[0].y);for(let t=1;t<e.length;t++)r.lineTo(e[t].x,e[t].y);r.closePath();let i=new u(r,1);i.rotateX(-Math.PI/2),i.computeVertexNormals();let a={uTime:{value:0},uWaves:{value:Array.from({length:ht},()=>new ve(0,0,0,0))},uWaveTint:{value:Array.from({length:ht},()=>new k(0,0,0))},uTerritory:{value:n.map(e=>new k(e.color).convertSRGBToLinear())},uTerrState:{value:new ve(1,1,1,1)},uRadius:{value:P.half},uDetail:{value:t.floorDetail},uCharge:{value:0}},o=new g({color:1778738,metalness:.12,roughness:.72,emissive:0,envMapIntensity:.38});o.onBeforeCompile=e=>{Object.assign(e.uniforms,a),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`+gt).replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
        {
...
`+_t)},o.customProgramCacheKey=()=>`arena-floor`;let s=new p(i,o);s.position.y=P.floorY,s.receiveShadow=!0,s.name=`deck`;let c=0,l=a.uWaves.value,d=a.uWaveTint.value,f=new k;return{mesh:s,uniforms:a,addWave(e,t,n=1,r=6742271){let i=-1,a=1e9;for(let e=0;e<ht;e++){if(l[e].w<=.001){i=e;break}let t=l[e].w*Math.exp(-l[e].z*3.4);t<a&&(a=t,i=e)}i<0&&(i=c=(c+1)%ht),l[i].set(e,t,0,n),f.set(r).convertSRGBToLinear(),d[i].copy(f)},setTerritory(e,t){let n=a.uTerrState.value;e===0?n.x=t:e===1?n.y=t:e===2?n.z=t:n.w=t},setCharge(e){a.uCharge.value=e},update(e,t){a.uTime.value=t;for(let t=0;t<ht;t++){let n=l[t];n.w<=.001||(n.z+=e,n.z>1.5&&(n.w=0))}},dispose(){i.dispose(),o.dispose()}}}function yt(){let{half:t,chamfer:n}=P,r=t-n;return[new e(-r,t),new e(r,t),new e(t,r),new e(t,-r),new e(r,-t),new e(-r,-t),new e(-t,-r),new e(-t,r)]}function bt(){let{half:e,chamfer:t}=P,n=(2*e-t)/Math.SQRT2,r=Math.SQRT1_2,i=[];for(let n=0;n<4;n++){let r=$e[n];i.push({nx:r.nx,nz:r.nz,d:e,goal:n,halfWidth:e-t})}return i.push({nx:r,nz:r,d:n,goal:-1}),i.push({nx:r,nz:-r,d:n,goal:-1}),i.push({nx:-r,nz:-r,d:n,goal:-1}),i.push({nx:-r,nz:r,d:n,goal:-1}),i}var xt=`
varying vec2 vUv;
varying vec3 vWPos;
...
}`,en=class{constructor(e,t=8){this.geo=new f(2,2),this.items=[];for(let n=0;n<t;n++){let t=new d({vertexShader:Qt,fragmentShader:$t,uniforms:{uColor:{value:new k(1,1,1)},uSize:{value:1},uFade:{value:0},uAngle:{value:0}},transparent:!0,depthWrite:!1,depthTest:!1,blending:2}),n=new p(this.geo,t);n.visible=!1,n.frustumCulled=!1,n.renderOrder=12,e.add(n),this.items.push({mesh:n,mat:t,life:0,dur:.12,size:1})}this.cursor=0}spawn(e,t,n,r,i,a,o=0){let s=this.items.find(e=>e.life<=0);return s||(s=this.items[this.cursor],this.cursor=(this.cursor+1)%this.items.length),s.life=i,s.dur=i,s.size=r,s.mesh.position.set(e,t,n),s.mesh.visible=!0,s.mat.uniforms.uColor.value.set(a).convertSRGBToLinear(),s.mat.uniforms.uAngle.value=o,s.mat.uniforms.uSize.value=r*.45,s.mat.uniforms.uFade.value=1,s}update(e){for(let t of this.items){if(t.life<=0)continue;if(t.life-=e,t.life<=0){t.mesh.visible=!1;continue}let n=1-t.life/t.dur,r=.45+.55*Math.min(1,n*5);t.mat.uniforms.uSize.value=t.size*r,t.mat.uniforms.uFade.value=(1-n)*(1-n)}}dispose(){this.geo.dispose();for(let e of this.items)e.mat.dispose(),e.mesh.parent?.remove(e.mesh)}};function tn(e,t,n){let r=e*.5-n,i=t*.5-n,a=new me;return a.moveTo(-r-n,-i),a.lineTo(-r-n,i),a.quadraticCurveTo(-r-n,i+n,-r,i+n),a.lineTo(r,i+n),a.quadraticCurveTo(r+n,i+n,r+n,i),a.lineTo(r+n,-i),a.quadraticCurveTo(r+n,-i-n,r,-i-n),a.lineTo(-r,-i-n),a.quadraticCurveTo(-r-n,-i-n,-r-n,-i),a}function nn(e,t,n,r=.12){let i=Math.min(r*2,Math.min(e,t)*.2),a=new be(tn(e-r*2,t-r*2,i),{depth:Math.max(.01,n-r*2),bevelEnabled:!0,bevelThickness:r,bevelSize:r,bevelSegments:1,curveSegments:2,steps:1});return a.rotateX(-Math.PI/2),a.translate(0,r,0),a.computeVertexNormals(),a}function rn(e,t,n,r=20){let i=new A(t,e,n,r,1,!1);return i.translate(0,n*.5,0),i}function an(e,t,n){let r=new ce,i=e,a=t,o=i*.82,s=[-i,0,0,i,0,0,i,n,0,-i,n,0,-o,0,a,o,0,a,-o,n*.8,a,o,n*.8,a];return r.setAttribute(`position`,new Se(s,3)),r.setIndex([0,2,1,0,3,2,4,5,7,4,7,6,3,7,2,3,6,7,0,1,5,0,5,4,0,4,6,0,6,3,1,7,5,1,2,7]),r.computeVertexNormals(),r}var J=16754738,on=0,sn=1,cn=2,ln=3,un=new oe,dn=new n,fn=new O,pn=new O(1,1,1),mn=new O(0,1,0),hn=class{constructor(e,t){this.scene=e,this.preset=t,this.bumpers=[],this.slings=[];for(let e=0;e<4;e++){let t=Math.PI*.25+e*Math.PI*.5,n=Math.cos(t),r=Math.sin(t),i=-r,a=n;for(let t of[-1,1])this.bumpers.push({x:n*V.wellR+i*V.bumperGap*t,z:r*V.wellR+a*V.bumperGap*t,r:V.bumperR,flash:0,cool:0,seed:Math.random(),well:e});let o=V.wellR+V.slingBack;this.slings.push({x:n*o,z:r*o,nx:-n,nz:-r,tx:i,tz:a,half:V.slingHalf,depth:V.slingDepth,flash:0,cool:0,seed:Math.random(),well:e})}this._build(),this.reset()}obstacles(){let e=this.bumpers.map(e=>({x:e.x,z:e.z,r:e.r}));for(let t of this.slings)e.push({x:t.x,z:t.z,r:t.half*.8});return e}_build(){let e=this.bumpers.length,t=this.slings.length;this.bumperState=new Float32Array(e*2),this.slingState=new Float32Array(t*2),this._attrs=[],this._time={value:0},this.bodyGeo=rn(V.bumperR*.88,V.bumperR*1.02,V.bumperH);let n=new g({color:2372425,metalness:.86,roughness:.34,envMapIntensity:1});n.onBeforeCompile=e=>{e.uniforms.uTime=this._time,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`,On=class{constructor(e,t){this.scene=e,this.preset=t,this.count=B.perQuadrant*bn,this.bricks=[],this.liveCount=0,this.spawned=0,this._nextAt=0,this.justSpawned=[];let{w:r,d:i,h:a}=B;this.geo=nn(r,i,a,B.bevel),this.auraGeo=nn(r+.16,i+.16,a+.1,B.bevel),this.state=new Float32Array(this.count*3),this.tint=new Float32Array(this.count*3),this._attrs=[],this.shell=this._buildShell(),this.aura=this._buildAura(),e.add(this.shell,this.aura),this._m=new oe,this._q=new n,this._pos=new O,this._scl=new O,this._col=new k}_attr(e,t,n,r){let i=new b(n,r);return i.setUsage(C),e.setAttribute(t,i),this._attrs.push(i),i}_buildShell(){this._attr(this.geo,`aState`,this.state,3),this._attr(this.geo,`aTint`,this.tint,3);let e=new g({color:1252135,metalness:.9,roughness:.34,envMapIntensity:.85}),t=new O(B.w,B.h,B.d);e.onBeforeCompile=e=>{e.uniforms.uDim={value:t},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
          ...
          ${En}`).replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
          {
...
float hNoise(vec2 p){
  ...
  return mix(mix(hHash(i), hHash(i + vec2(1,0)), f.x),
...
}`,In=class{constructor(e,t){this.scene=e,this.preset=t,this.x=0,this.z=0,this.phase=An,this.timer=H.first,this.strength=0,this.quadrant=Math.floor(Math.random()*4),this.justWarned=!1,this.justOpened=!1,this.justClosed=!1,this._warned=!1,this.root=new j,this.root.visible=!1,e.add(this.root),this._time={value:0},this._amount={value:0},this._build()}_build(){this.coreMat=new d({uniforms:{uTime:this._time,uAmount:this._amount},vertexShader:`
        ...
        }`}),this.edge=new p(t,this.edgeMat),this.edge.position.y=P.floorY-P.playY+.045,this.edge.renderOrder=4,this.root.add(this.core,this.disc,this.edge)}reset(){this.phase=An,this.timer=H.first,this.strength=0,this.justWarned=this.justOpened=this.justClosed=!1,this._warned=!1,this.root.visible=!1}get live(){return this.strength>.001}get cycle01(){return this.phase===An?U(1-this.timer/H.cooldown,0,1):this.phase===Nn?U(this.timer/H.duration,0,1):this.phase===jn?1:this.strength}_place(e){this.quadrant=(this.quadrant+1)%4;let t=0,n=0;for(let r=0;r<12;r++){let r=(this.quadrant+K(.18,.82))*Math.PI*.5;if(t=Math.cos(r)*H.spawnR,n=Math.sin(r)*H.spawnR,!e||this._clearOf(e,t,n))break}this.x=t,this.z=n,this.root.position.set(t,P.playY,n)}_clearOf(e,t,n){for(let r of e.standing()){let e=U(t-r.x,-r.hw,r.hw),i=U(n-r.z,-r.hd,r.hd);if(Math.hypot(t-r.x-e,n-r.z-i)<H.coreR+H.clearance)return!1}return!0}affect(e,t){if(this.strength<=.001)return!1;let n=this.x-e.x,r=this.z-e.z,i=n*n+r*r,a=H.radius;if(i>a*a||i<1e-6)return!1;let o=Math.sqrt(i),s=o/a,c=(1-s*s)*Ln(o),l=H.pull*c*this.strength*t,u=e.speed||Math.hypot(e.vx,e.vz)||1;e.vx+=n/o*l,e.vz+=r/o*l;let d=Math.hypot(e.vx,e.vz)||1;return e.vx=e.vx/d*u,e.vz=e.vz/d*u,!0}update(e,t,n){switch(this.justWarned=this.justOpened=this.justClosed=!1,this._time.value=t,this.timer-=e,this.phase){case An:this.timer<=H.warnTime&&!this._warned&&(this._warned=!0,this._place(n),this.justWarned=!0),this.timer<=0&&(this.phase=Mn,this.timer=H.openTime,this._warned=!1,this.justOpened=!0,this.root.visible=!0);break;case Mn:this.strength=1-U(this.timer/H.openTime,0,1),this.timer<=0&&(this.phase=Nn,this.timer=H.duration,this.strength=1);break;case Nn:this.timer<=0&&(this.phase=Pn,this.timer=H.openTime,this.justClosed=!0);break;case Pn:this.strength=U(this.timer/H.openTime,0,1),this.timer<=0&&(this.phase=An,this.timer=H.cooldown,this.strength=0,this.root.visible=!1)}if(!this.root.visible)return;this._amount.value=this.strength;let r=this.strength**.65;this.core.scale.setScalar(r),this.disc.scale.set(r,1,r),this.disc.rotation.y=t*.35,this.edge.scale.set(.35+r*.65,1,.35+r*.65)}dispose(){this.core.geometry.dispose(),this.disc.geometry.dispose(),this.edge.geometry.dispose(),this.coreMat.dispose(),this.discMat.dispose(),this.edgeMat.dispose(),this.scene.remove(this.root)}};function Ln(e){let t=U(e/(H.coreR*2.2),0,1);return t*t*(3-2*t)}var Rn=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
// in GLSL and several mobile drivers return NaN for it, which then blows out
// the bloom chain — so we never hand a signed value to pow().
float gauss(float x) { return exp(-x * x); }`,Bn=`
precision highp float;
varying vec2 vUv;
