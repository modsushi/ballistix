import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as ee,W as S,X as te,Y as ne,Z as re,_ as C,a as w,b as T,c as E,d as D,et as O,f as k,g as ie,h as A,i as ae,j as oe,k as se,l as ce,m as le,n as j,nt as ue,o as de,p as fe,q as pe,r as me,s as he,t as ge,tt as _e,u as ve,v as ye,w as be,x as M,y as xe,z as Se}from"./three-CblLknTi.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var Ce={LOW:0,MED:1,HIGH:2};function we(e){try{let t=e.getExtension(`WEBGL_debug_renderer_info`);return t?(e.getParameter(t.UNMASKED_RENDERER_WEBGL)||``).toLowerCase():``}catch{return``}}function Te(e){let t=matchMedia(`(hover: none) and (pointer: coarse)`).matches,n=navigator.hardwareConcurrency||4,r=navigator.deviceMemory||(t?4:8),i=we(e),a=0;return a+=t?0:3,a+=n>=8?2:+(n>=6),a+=r>=8?2:+(r>=4),/apple\s*(a1[4-9]|a[2-9]\d|m[1-9])/.test(i)?a+=3:/apple/.test(i)&&(a+=2),/adreno\s*(7\d\d|6[5-9]\d)/.test(i)&&(a+=2),/mali-g(7[1-9]|[89]\d)/.test(i)&&(a+=1),/(rtx|radeon rx|geforce)/.test(i)&&(a+=3),/(swiftshader|llvmpipe|software)/.test(i)&&(a-=6),{tier:a>=7?Ce.HIGH:a>=4?Ce.MED:Ce.LOW,touch:t,cores:n,mem:r,renderer:i}}var Ee=[{maxDpr:1.5,msaa:0,bloomLevels:4,shadows:!0,shadowSize:768,sparks:260,orbLights:1,envSize:128,grain:!0,aberration:.55,floorDetail:.55,starCount:900,trailSegments:14},{maxDpr:2,msaa:4,bloomLevels:5,shadows:!0,shadowSize:1024,sparks:520,orbLights:2,envSize:256,grain:!0,aberration:.8,floorDetail:.8,starCount:1600,trailSegments:20},{maxDpr:2,msaa:4,bloomLevels:6,shadows:!0,shadowSize:2048,sparks:900,orbLights:4,envSize:256,grain:!0,aberration:1,floorDetail:1,starCount:2600,trailSegments:26}],De=class{constructor(e=.62){this.scale=1,this.min=e,this.avg=16.7,this.acc=0,this.dirty=!1}update(e){return e>120?!1:(this.avg+=(e-this.avg)*.045,this.avg>20.5?this.acc+=1:this.avg<13.2?--this.acc:this.acc*=.9,this.acc>70&&this.scale>this.min?(this.scale=Math.max(this.min,this.scale-.09),this.acc=0,!0):this.acc<-140&&this.scale<1&&(this.scale=Math.min(1,this.scale+.06),this.acc=0,!0))}},N=`models/space/`,Oe=`models/station/`,ke=[[`craft_speederA`,N],[`craft_speederB`,N],[`craft_speederC`,N],[`craft_speederD`,N],[`structure`,N],[`structure_detailed`,N],[`structure_diagonal`,N],[`supports_high`,N],[`supports_low`,N],[`platform_large`,N],[`platform_long`,N],[`platform_high`,N],[`rail_middle`,N],[`rail_end`,N],[`pipe_straight`,N],[`pipe_ring`,N],[`pipe_ringHigh`,N],[`pipe_supportHigh`,N],[`pipe_corner`,N],[`machine_generator`,N],[`machine_generatorLarge`,N],[`machine_wireless`,N],[`satelliteDish`,N],[`satelliteDish_large`,N],[`turret_single`,N],[`turret_double`,N],[`hangar_roundA`,N],[`hangar_smallB`,N],[`barrels`,N],[`barrels_rail`,N],[`rocket_baseA`,N],[`rocket_fuelA`,N],[`monorail_trackStraight`,N],[`monorail_trackSupport`,N],[`rock_crystals`,N],[`rock_crystalsLargeA`,N],[`meteor`,N],[`meteor_detailed`,N],[`rock_largeA`,N],[`container`,Oe],[`container-tall`,Oe],[`structure-barrier-high`,Oe],[`structure-panel`,Oe],[`display-wall`,Oe],[`computer-wide`,Oe]],Ae=class{constructor(){this.models=new Map,this.loader=new ge}async loadAll(e){let t=ke.length,n=0,r=ke.slice();await Promise.all(Array.from({length:6},async()=>{for(;;){let i=r.shift();if(!i)return;let[a,o]=i;try{let e=await this.loader.loadAsync(`${o}${a}.glb`);this.models.set(a,this._prepare(e.scene,a))}catch(e){console.warn(`[assets] failed: ${a}`,e),this.models.set(a,new M)}n++,e?.(n,t,a)}}));try{let e=await new re().loadAsync(`${Oe}Textures/colormap.png`);e.colorSpace=S,e.flipY=!1,e.anisotropy=4,this.colormap=e}catch(e){console.warn(`[assets] colormap missing`,e)}return this.models}_prepare(e,t){e.updateMatrixWorld(!0);let n=new M;e.traverse(e=>{if(!e.isMesh||!e.geometry)return;let t=e.geometry.clone();t.applyMatrix4(e.matrixWorld),t.attributes.normal||t.computeVertexNormals();let r=new p(t,e.material);r.name=e.name,r.userData.srcMat=e.material?.name||`default`,r.castShadow=!0,r.receiveShadow=!0,n.add(r)});let r=new de().setFromObject(n);r.isEmpty()&&r.set(new O,new O);let i=(r.min.x+r.max.x)*.5,a=(r.min.z+r.max.z)*.5,o=r.min.y;for(let e of n.children)e.geometry.translate(-i,-o,-a),e.geometry.computeBoundingSphere(),e.geometry.computeBoundingBox();return n.userData.modelName=t,n.userData._bounds=new de().setFromObject(n),n}clone(e){let t=this.models.get(e);if(!t)return console.warn(`[assets] missing model: ${e}`),new M;let n=t.clone(!0);return n.traverse(e=>{e.isMesh&&(e.userData.srcMat=e.userData.srcMat)}),n}bounds(e){let t=this.models.get(e);return t?(t.userData._bounds||(t.userData._bounds=new de().setFromObject(t)),t.userData._bounds):new de(new O,new O(1,1,1))}},je=new Map;function P(e,t){if(je.has(e))return je.get(e);let n=new g(t);return je.set(e,n),n}var Me=null;function Ne(e){Me=e;let t=je.get(`f.colormap`);t&&(t.map=e,t.needsUpdate=!0)}function Pe(){return{colormap:P(`f.colormap`,{map:Me,color:6451327,metalness:.55,roughness:.66,envMapIntensity:.45}),metal:P(`f.metal`,{color:5464954,metalness:.9,roughness:.5,envMapIntensity:.5}),metalDark:P(`f.metalDark`,{color:3358543,metalness:.86,roughness:.6,envMapIntensity:.45}),dark:P(`f.dark`,{color:856603,metalness:.42,roughness:.6,envMapIntensity:.45}),metalRed:P(`f.accent`,{color:928312,metalness:.55,roughness:.38,emissive:2009544,emissiveIntensity:.28,envMapIntensity:.9}),_defaultMat:P(`f.default`,{color:4871781,metalness:.72,roughness:.55,envMapIntensity:.5}),rock:P(`f.rock`,{color:1909034,metalness:.06,roughness:.92,envMapIntensity:.4}),rockTrack:P(`f.rockTrack`,{color:1579811,metalness:.05,roughness:.95,envMapIntensity:.38}),crystal:P(`f.crystal`,{color:866890,metalness:.1,roughness:.12,emissive:3596543,emissiveIntensity:1.5,envMapIntensity:1.2,transparent:!0,opacity:.9})}}function Fe(e,t){let n=new k(e),r=new k(t),i={h:0,s:0,l:0};n.getHSL(i);let a=new k().setHSL(i.h,.58,.64),o=new k().setHSL(i.h,.62,.3),s=new k().setHSL(i.h,.55,.14);return{metal:new g({color:a,metalness:.62,roughness:.33,envMapIntensity:1.8}),metalDark:new g({color:o,metalness:.58,roughness:.46,envMapIntensity:1.5}),dark:new g({color:s,metalness:.5,roughness:.45,envMapIntensity:1}),metalRed:new g({color:r.clone().multiplyScalar(.35),metalness:.4,roughness:.3,emissive:n,emissiveIntensity:3.4,envMapIntensity:1}),_defaultMat:new g({color:a,metalness:.85,roughness:.38,envMapIntensity:1.2})}}function Ie(e,t,n=`metal`){return e.traverse(e=>{e.isMesh&&(e.material=t[e.userData.srcMat]||t[n]||t._defaultMat)}),e}var Le=`
...
}`,Ue=new O(.42,.76,.5).normalize();function We(e,t,n){let r=new M;r.name=`environment`;let a=new d({vertexShader:Re,fragmentShader:Le,side:1,depthWrite:!1,uniforms:{uHorizon:{value:new k(1186360).convertSRGBToLinear()},uZenith:{value:new k(329749).convertSRGBToLinear()},uNebulaA:{value:new k(3810448).convertSRGBToLinear().multiplyScalar(2.1)},uNebulaB:{value:new k(1410488).convertSRGBToLinear().multiplyScalar(1.7)},uSunDir:{value:Ue.clone()},uSunColor:{value:new k(12575999).convertSRGBToLinear()}}}),o=new s,c=new p(new he(2,2,2),a);o.add(c);let l=new ae(n.envSize,{type:y,format:ee,generateMipmaps:!0,minFilter:h,magFilter:i}),u=new le(.1,10,l),f=e.getRenderTarget();u.update(e,o),e.setRenderTarget(f);let m=new me(e);m.compileCubemapShader();let g=m.fromCubemap(l.texture);t.environment=g.texture,t.background=l.texture,t.backgroundIntensity=1.25,t.environmentIntensity=2.1,m.dispose(),c.geometry.dispose(),a.dispose();let _=n.starCount,v=new Float32Array(_*3),b=new Float32Array(_),S=new Float32Array(_),re=new Float32Array(_*3),C=new k;for(let e=0;e<_;e++){let t=Math.random()*2-1,n=Math.random()*Math.PI*2,r=Math.sqrt(1-t*t);v[e*3]=Math.cos(n)*r*620,v[e*3+1]=Math.max(-.18,t)*620*.9+40,v[e*3+2]=Math.sin(n)*r*620,b[e]=1.4+Math.random()**3.2*8.2,S[e]=Math.random()*100;let i=Math.random();i>.9?C.setHSL(.08,.55,.72):i>.76?C.setHSL(.11,.3,.84):i>.34?C.setHSL(.58,.18,.92):C.setHSL(.6,.42,.86),re[e*3]=C.r,re[e*3+1]=C.g,re[e*3+2]=C.b}let w=new ce;w.setAttribute(`position`,new E(v,3)),w.setAttribute(`aSize`,new E(b,1)),w.setAttribute(`aPhase`,new E(S,1)),w.setAttribute(`aTint`,new E(re,3)),w.boundingSphere=new ne(new O,868);let T=new d({vertexShader:ze,fragmentShader:Be,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(e.getPixelRatio(),2)}},transparent:!0,blending:2,depthWrite:!1,depthTest:!1}),D=new Se(w,T);D.renderOrder=-900,D.frustumCulled=!1,r.add(D);let ie=new d({vertexShader:`varying vec3 vWorld;
`+Ve,fragmentShader:He,uniforms:{uSunDir:{value:Ue.clone()},uTime:{value:0}},depthWrite:!1}),A=new p(new te(1,64,48),ie);A.scale.setScalar(95),A.position.set(-390,105,-640),A.renderOrder=-880,A.frustumCulled=!1,r.add(A);let oe=new x(1.42,2.35,128,1),se=new d({transparent:!0,blending:2,depthWrite:!1,side:2,uniforms:{uSunDir:{value:Ue.clone()}},vertexShader:`
      ...
      }`}),j=new p(oe,se);return j.scale.setScalar(95),j.position.copy(A.position),j.rotation.set(-Math.PI/2+.3,.22,.5),j.renderOrder=-870,j.frustumCulled=!1,r.add(j),t.add(r),{group:r,envTexture:g.texture,update(e){T.uniforms.uTime.value=e,ie.uniforms.uTime.value=e},setPixelRatio(e){T.uniforms.uPixelRatio.value=Math.min(e,2)},dispose(){w.dispose(),T.dispose(),A.geometry.dispose(),ie.dispose(),oe.dispose(),se.dispose(),l.dispose(),g.dispose()}}}var Ge=`
out vec2 vUv;
void main() {
  vUv = uv;
...
}`;function Xe(e,t){return new c({glslVersion:T,vertexShader:`in vec3 position;
in vec2 uv;
`+Ge,fragmentShader:e,uniforms:t,depthTest:!1,depthWrite:!1})}var Ze=class{constructor(t,n){this.renderer=t,this.levels=n.bloomLevels,this.preset=n,this.scene=new s,this.cam=new o(-1,1,1,-1,0,1);let r=new ce;r.setAttribute(`position`,new E(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3)),r.setAttribute(`uv`,new E(new Float32Array([0,0,2,0,0,2]),2)),this.quad=new p(r,null),this.quad.frustumCulled=!1,this.scene.add(this.quad);let a={type:y,format:ee,minFilter:i,magFilter:i,wrapS:D,wrapT:D,depthBuffer:!0,generateMipmaps:!1,colorSpace:se};this.hdr=new ue(2,2,{...a,samples:n.msaa|0}),this.mips=[],this.mPre=Xe(Ke,{uTex:{value:null},uTexel:{value:new e},uThreshold:{value:1.28},uKnee:{value:.55}}),this.mDown=Xe(qe,{uTex:{value:null},uTexel:{value:new e}}),this.mUp=Xe(Je,{uTex:{value:null},uTexel:{value:new e},uRadius:{value:1},uStretch:{value:1.42}}),this.mUp.blending=2,this.mComp=Xe(Ye,{uScene:{value:null},uBloom:{value:null},uRes:{value:new e},uTime:{value:0},uExposure:{value:1},uBloomStrength:{value:.42},uAberration:{value:n.aberration},uVignette:{value:.44},uGrain:{value:n.grain?.011:0},uRadial:{value:0},uFlash:{value:0},uFlashTint:{value:new k(1,1,1)},uDesat:{value:0}}),this.u=this.mComp.uniforms}setSize(e,t){e=Math.max(2,e|0),t=Math.max(2,t|0),this.w=e,this.h=t,this.hdr.setSize(e,t),this.u.uRes.value.set(e,t);for(let e of this.mips)e.dispose();this.mips=[];let n=e,r=t;for(let e=0;e<this.levels;e++){n=Math.max(1,n>>1),r=Math.max(1,r>>1);let t=new ue(n,r,{type:y,format:ee,minFilter:i,magFilter:i,wrapS:D,wrapT:D,depthBuffer:!1,generateMipmaps:!1,colorSpace:se});if(this.mips.push(t),n<=2||r<=2){this.activeLevels=e+1;break}this.activeLevels=e+1}}_pass(e,t){this.quad.material=e,this.renderer.setRenderTarget(t),this.renderer.render(this.scene,this.cam)}renderScene(e,t){this.renderer.setRenderTarget(this.hdr),this.renderer.clear(!0,!0,!0),this.renderer.render(e,t)}present(e){let t=this.activeLevels;this.mPre.uniforms.uTex.value=this.hdr.texture,this.mPre.uniforms.uTexel.value.set(1/this.w,1/this.h),this._pass(this.mPre,this.mips[0]);for(let e=1;e<t;e++){let t=this.mips[e-1];this.mDown.uniforms.uTex.value=t.texture,this.mDown.uniforms.uTexel.value.set(1/t.width,1/t.height),this._pass(this.mDown,this.mips[e])}for(let e=t-1;e>0;e--){let t=this.mips[e];this.mUp.uniforms.uTex.value=t.texture,this.mUp.uniforms.uTexel.value.set(1/t.width,1/t.height),this._pass(this.mUp,this.mips[e-1])}this.u.uScene.value=this.hdr.texture,this.u.uBloom.value=this.mips[0].texture,this.u.uTime.value=e,this.renderer.setRenderTarget(null),this._pass(this.mComp,null)}dispose(){this.hdr.dispose();for(let e of this.mips)e.dispose();this.mPre.dispose(),this.mDown.dispose(),this.mUp.dispose(),this.mComp.dispose(),this.quad.geometry.dispose()}},F={half:19,chamfer:9.6,wallH:2.9,floorY:0,playY:.92},Qe=[{key:`S`,nx:0,nz:1,ang:0},{key:`W`,nx:-1,nz:0,ang:Math.PI*.5},{key:`N`,nx:0,nz:-1,ang:Math.PI},{key:`E`,nx:1,nz:0,ang:Math.PI*1.5}],I=[{id:0,name:`YOU`,color:2417407,deep:688022,css:`#24e2ff`,craft:`craft_speederC`,human:!0},{id:1,name:`VEX`,color:16723880,deep:9573214,css:`#ff2fa8`,craft:`craft_speederB`,human:!1},{id:2,name:`KORR`,color:16756768,deep:9395205,css:`#ffb020`,craft:`craft_speederA`,human:!1},{id:3,name:`SABLE`,color:8847165,deep:4427802,css:`#86ff3d`,craft:`craft_speederD`,human:!1}],L={startPoints:5,maxPoints:7,orbSchedule:[{t:0,n:1},{t:24,n:2},{t:56,n:3},{t:92,n:4}],orbCapMobile:3,respawnDelay:1.05,serveDelay:1.5},R={halfLen:2.4,halfThick:.46,standoff:2.45,maxSpeed:40,damp:26,track:34,moveSpeed:28,minPress:.045,returnMax:0,returnSpeed:3.5,returnRamp:.45,bankMax:.62,hover:.16},z={cooldown:15,startCharge:.55,duration:2.6,height:2.2,openTime:.18,fadeTime:.3,speedGain:.9,english:.34},B={radius:.52,baseSpeed:13.2,maxSpeed:33,rallyGain:.34,paddleBoost:1.05,spinInfluence:.26,angleInfluence:.78,minAngle:.3,cruise:19,bleed:2.4},V={perQuadrant:4,spawnFirst:8,spawnEvery:5,w:2.35,d:1.18,h:1.3,bevel:.11,innerR:4.6,outerR:12.6,minGap:.72,wellClear:2,hpInner:3,hpOuter:2,hpSplit:8.4,slow:.55,perPoint:10,regen:13,reformTime:.85,breakTime:.42},H={enabled:!1,upTime:15,downTime:15,warnTime:1.1,riseTime:.55,wellR:10.4,bumperGap:1.62,bumperR:.95,bumperH:1.55,kick:3.4,kickFloor:17,scatter:.16,slingBack:2.35,slingHalf:2.2,slingH:1.05,slingDepth:1.35,slingSpeed:25.5,slingSpread:.62,cool:.09},$e=[{name:`ROOKIE`,react:.34,err:3.6,speed:.51,aggression:.25},{name:`PILOT`,react:.22,err:2.3,speed:.66,aggression:.45},{name:`ACE`,react:.13,err:1.2,speed:.82,aggression:.7}],U=(e,t,n)=>e<t?t:e>n?n:e,W=(e,t,n)=>e+(t-e)*n,et=e=>e*e*(3-2*e),G=(e,t,n,r)=>W(e,t,1-Math.exp(-n*r)),K=(e,t)=>e+Math.random()*(t-e),tt=(e,t)=>e+Math.random()*(t-e+1)|0,nt=e=>e[Math.random()*e.length|0];function rt(e){let t=Math.floor(e),n=e-t,r=n*n*(3-2*n),i=e=>{let t=Math.sin(e*127.1)*43758.5453;return(t-Math.floor(t))*2-1};return W(i(t),i(t+1),r)}var it=(()=>{let{half:e,chamfer:t,wallH:n,playY:r}=F,i=e-t,a=(e,t,n)=>new O(e,t,n),o=i-R.halfLen*.42,s=e-R.standoff;return{width:[a(-e,0,-i),a(e,0,-i),a(-i,0,-e),a(i,0,-e),a(-o-R.halfLen,r,s),a(o+R.halfLen,r,s)],top:[a(-i,2.5,-e),a(i,2.5,-e),a(-e,2.5,-i),a(e,2.5,-i)],bottom:[a(-i,0,e),a(0,0,e),a(i,0,e),a(-o,r+1.5,s),a(o,r+1.5,s)]}})(),at=class{constructor(e){this.cam=new l(50,e,.5,1400),this.trauma=0,this.traumaTime=0,this.fovPunch=0,this.leanX=0,this.leanZ=0,this.targetLeanX=0,this.targetLeanZ=0,this.zoom=1,this.targetZoom=1,this.intro=0,this.introActive=!1,this.kickX=0,this.kickY=0,this._base=new O,this._look=new O,this.stableCam=new l(50,e,.5,1400),this.resize(e)}resize(e){this.aspect=e,this.cam.aspect=e;let t=U((1.35-e)/(1.35-.52),0,1);this.portraitness=et(t),this.elevation=W(35,66,this.portraitness)*Math.PI/180,this.baseFov=W(48,62,this.portraitness),this.cam.fov=this.baseFov,this.lookLift=0,this._solveDistance(),this.cam.updateProjectionMatrix()}_solveDistance(){let e=this.baseFov*Math.PI/180,t=2*Math.atan(Math.tan(e/2)*this.aspect),n=W(1,.995,this.portraitness),r=W(.95,.94,this.portraitness),i=W(.88,.9,this.portraitness),a=F.half*1.2/Math.sin(Math.min(e,t)/2),o=0,s=lt;s.fov=this.baseFov,s.aspect=this.aspect,s.updateProjectionMatrix();for(let e=0;e<32;e++){let e=Math.cos(this.elevation),t=Math.sin(this.elevation);s.position.set(0,t*a,e*a),s.lookAt(0,o,o*.15),s.updateMatrixWorld(!0);let c=0,l=0,u=0;for(let e of it.width)ct.copy(e).project(s),c=Math.max(c,Math.abs(ct.x)/n);for(let e of it.top)ct.copy(e).project(s),l=Math.max(l,Math.max(0,ct.y)/r);for(let e of it.bottom)ct.copy(e).project(s),u=Math.max(u,Math.max(0,-ct.y)/i);let d=u-l;o=U(o-d*3.2,-7,2);let f=Math.max(c,l,u);if(Math.abs(f-1)<.003&&Math.abs(d)<.006)break;a*=f}this.distance=a,this.lookLift=o;let c=this.stableCam;c.fov=this.baseFov,c.aspect=this.aspect,c.updateProjectionMatrix(),c.position.set(0,Math.sin(this.elevation)*a,Math.cos(this.elevation)*a),c.lookAt(0,o,o*.15),c.updateMatrixWorld(!0)}shake(e){this.trauma=Math.min(1,this.trauma+e)}kick(e,t,n){this.kickX+=e*n,this.kickY+=t*n}punch(e){this.fovPunch=Math.min(9,this.fovPunch+e)}lookToward(e,t,n=1){this.targetLeanX=U(e*.055,-1.4,1.4)*n,this.targetLeanZ=U(t*.045,-1.2,1.2)*n}startIntro(){this.intro=0,this.introActive=!0}update(e,t){this.trauma=Math.max(0,this.trauma-e*1.55),this.traumaTime+=e*(28+this.trauma*26),this.fovPunch=G(this.fovPunch,0,6.5,e),this.kickX=G(this.kickX,0,8,e),this.kickY=G(this.kickY,0,8,e),this.leanX=G(this.leanX,this.targetLeanX,2.6,e),this.leanZ=G(this.leanZ,this.targetLeanZ,2.6,e),this.zoom=G(this.zoom,this.targetZoom,3.2,e);let n=this.distance*this.zoom,r=this.elevation,i=0;if(this.introActive){this.intro+=e;let t=U(this.intro/3.4,0,1),a=1-(1-t)**3;n*=W(.55,1,a),r=W(11*Math.PI/180,r,a),i=W(-.85,0,a),t>=1&&(this.introActive=!1)}i+=Math.sin(t*.13)*.019,r+=Math.sin(t*.097+1.3)*.012;let a=Math.cos(r),o=Math.sin(r);this._base.set(Math.sin(i)*a*n+this.leanX,o*n,Math.cos(i)*a*n+this.leanZ),this._look.set(this.leanX*1.7,this.lookLift,this.leanZ*1.7+this.lookLift*.15),this.cam.position.copy(this._base),this.cam.lookAt(this._look);let s=this.trauma*this.trauma;if(s>1e-4){let e=this.traumaTime,t=rt(e)*s*1.35,n=rt(e+47.3)*s*1.15,r=rt(e+91.7)*s*.055;this.cam.translateX(t+this.kickX*.5),this.cam.translateY(n+this.kickY*.35),this.cam.rotateZ(r)}else(this.kickX||this.kickY)&&(this.cam.translateX(this.kickX*.5),this.cam.translateY(this.kickY*.35));let c=this.baseFov+this.fovPunch+s*1.6;Math.abs(c-this.cam.fov)>.005&&(this.cam.fov=c,this.cam.updateProjectionMatrix()),this.cam.updateMatrixWorld()}makeMapper(e,t,n,r){let i=F.half-R.standoff;ot.set(e.nx*i+e.tx*-t,F.playY,e.nz*i+e.tz*-t),st.set(e.nx*i+e.tx*t,F.playY,e.nz*i+e.tz*t),ot.project(this.stableCam),st.project(this.stableCam);let a=(ot.x*.5+.5)*r,o=(st.x*.5+.5)*r,s=(a+o)*.5;a=s+(a-s)/n,o=s+(o-s)/n;let c=o-a;return Math.abs(c)<1?{map:()=>0,sign:1}:{map:e=>(e-a)/c*2*t-t,sign:c>0?1:-1}}},ot=new O,st=new O,ct=new O,lt=new l(50,1,.5,1400),q=8,ut=`
varying vec3 vWPos;
uniform float uTime;
uniform vec4  uWaves[${q}];      // xz = origin, z = age, w = strength
uniform vec3  uWaveTint[${q}];
...
`;function ft(e,t,n){let r=new pe;r.moveTo(e[0].x,e[0].y);for(let t=1;t<e.length;t++)r.lineTo(e[t].x,e[t].y);r.closePath();let i=new u(r,1);i.rotateX(-Math.PI/2),i.computeVertexNormals();let a={uTime:{value:0},uWaves:{value:Array.from({length:q},()=>new _e(0,0,0,0))},uWaveTint:{value:Array.from({length:q},()=>new k(0,0,0))},uTerritory:{value:n.map(e=>new k(e.color).convertSRGBToLinear())},uTerrState:{value:new _e(1,1,1,1)},uRadius:{value:F.half},uDetail:{value:t.floorDetail},uCharge:{value:0}},o=new g({color:1778738,metalness:.12,roughness:.72,emissive:0,envMapIntensity:.38});o.onBeforeCompile=e=>{Object.assign(e.uniforms,a),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`+ut).replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
        {
...
`+dt)},o.customProgramCacheKey=()=>`arena-floor`;let s=new p(i,o);s.position.y=F.floorY,s.receiveShadow=!0,s.name=`deck`;let c=0,l=a.uWaves.value,d=a.uWaveTint.value,f=new k;return{mesh:s,uniforms:a,addWave(e,t,n=1,r=6742271){let i=-1,a=1e9;for(let e=0;e<q;e++){if(l[e].w<=.001){i=e;break}let t=l[e].w*Math.exp(-l[e].z*3.4);t<a&&(a=t,i=e)}i<0&&(i=c=(c+1)%q),l[i].set(e,t,0,n),f.set(r).convertSRGBToLinear(),d[i].copy(f)},setTerritory(e,t){let n=a.uTerrState.value;e===0?n.x=t:e===1?n.y=t:e===2?n.z=t:n.w=t},setCharge(e){a.uCharge.value=e},update(e,t){a.uTime.value=t;for(let t=0;t<q;t++){let n=l[t];n.w<=.001||(n.z+=e,n.z>1.5&&(n.w=0))}},dispose(){i.dispose(),o.dispose()}}}function pt(){let{half:t,chamfer:n}=F,r=t-n;return[new e(-r,t),new e(r,t),new e(t,r),new e(t,-r),new e(r,-t),new e(-r,-t),new e(-t,-r),new e(-t,r)]}function mt(){let{half:e,chamfer:t}=F,n=(2*e-t)/Math.SQRT2,r=Math.SQRT1_2,i=[];for(let n=0;n<4;n++){let r=Qe[n];i.push({nx:r.nx,nz:r.nz,d:e,goal:n,halfWidth:e-t})}return i.push({nx:r,nz:r,d:n,goal:-1}),i.push({nx:r,nz:-r,d:n,goal:-1}),i.push({nx:-r,nz:-r,d:n,goal:-1}),i.push({nx:-r,nz:r,d:n,goal:-1}),i}var ht=`
varying vec2 vUv;
varying vec3 vWPos;
...
void main() {
  ...
  gl_FragColor = vec4(col * (0.5 + uHealth * 0.9), alpha);
}`,_t=class{constructor(t,n,r){this.mat=new d({vertexShader:ht,fragmentShader:gt,transparent:!0,depthWrite:!1,blending:2,side:2,uniforms:{uColor:{value:new k(r).convertSRGBToLinear()},uTime:{value:0},uHealth:{value:1},uHit:{value:0},uHitPos:{value:new e(.5,.35)},uSealed:{value:0},uNormal:{value:new O(0,0,1)}}});let i=new f(t,n,1,1);this.mesh=new p(i,this.mat),this.mesh.renderOrder=6,this._hit=0,this._sealTarget=0}hit(e,t=.34,n=1){this.mat.uniforms.uHitPos.value.set(e,t),this._hit=Math.min(1.6,this._hit+n)}setHealth(e){this.mat.uniforms.uHealth.value=e}seal(){this._sealTarget=1}setNormal(e,t,n){this.mat.uniforms.uNormal.value.set(e,t,n)}update(e,t){let n=this.mat.uniforms;n.uTime.value=t,this._hit*=Math.exp(-e*4.2),this._hit<.002&&(this._hit=0),n.uHit.value=this._hit,n.uSealed.value+=(this._sealTarget-n.uSealed.value)*Math.min(1,e*3.2)}dispose(){this.mesh.geometry.dispose(),this.mat.dispose()}},vt=class{constructor(e){this.set=e,this.groups=new Map,this.count=0}add(e){e.updateWorldMatrix(!0,!0),e.traverse(e=>{if(!e.isMesh||!e.geometry)return;let t=e.userData.srcMat||`metal`,n=e.geometry.clone();if(n.applyMatrix4(e.matrixWorld),!n.attributes.uv){let e=n.attributes.position.count;n.setAttribute(`uv`,new E(new Float32Array(e*2),2))}for(let e of Object.keys(n.attributes))e!==`position`&&e!==`normal`&&e!==`uv`&&n.deleteAttribute(e);n.morphAttributes={},this.groups.has(t)||this.groups.set(t,[]),this.groups.get(t).push(n),this.count++})}build(e,t={}){let n=[];for(let[r,i]of this.groups){if(!i.length)continue;let a=i.length===1?i[0]:j(i,!1);if(!a){console.warn(`[batch] merge failed for material "${r}"`);continue}if(i.length>1)for(let e of i)e.dispose();a.computeBoundingSphere();let o=this.set[r]||this.set.metal||this.set._defaultMat,s=new p(a,o);s.castShadow=t.castShadow??!0,s.receiveShadow=t.receiveShadow??!0,s.name=`${t.name||`batch`}:${r}`,e.add(s),n.push(s)}return this.groups.clear(),n}},yt=2*(F.half-F.chamfer),bt=F.chamfer*Math.SQRT2,J=1.5,xt=class{constructor(e,t,n){this.scene=e,this.assets=t,this.preset=n,this.root=new M,this.root.name=`arena`,e.add(this.root),this.mats=Pe(),this.planes=mt(),this.outline=pt(),this._buildDeck(),this._buildWalls(),this._buildBarriers(),this._buildSubstructure(),this._buildDressing(),this._buildLights()}_buildDeck(){this.floor=ft(this.outline,this.preset,I),this.root.add(this.floor.mesh);let e=new p(new A(F.half*1.02,F.half*.94,1.1,8,1),new g({color:593173,metalness:.85,roughness:.55}));e.rotation.y=Math.PI/8,e.position.y=-.58,e.receiveShadow=!0,this.root.add(e)}_buildWalls(){let e=new M;this.root.add(e);let t=new g({color:1712687,metalness:.55,roughness:.62,envMapIntensity:.55}),n=new g({color:858658,metalness:.6,roughness:.25,emissive:2076888,emissiveIntensity:.85});this.railMat=n;let r=(r,i,a,o,s)=>{let c=Math.atan2(i,a),l=i*(o+J*.5),u=a*(o+J*.5),d=new p(new he(r,F.wallH,J),t);d.position.set(l,F.wallH*.5,u),d.rotation.y=c,d.castShadow=!0,d.receiveShadow=!0,e.add(d);let f=new p(new he(r,.19,J*.26),n);f.position.set(l-i*J*.3,F.wallH+.04,u-a*J*.3),f.rotation.y=c,e.add(f);let m=new p(new he(r*.96,.1,.08),new g({color:528406,metalness:.3,roughness:.4,emissive:s,emissiveIntensity:1.15}));return m.position.set(i*(o-.06),.34,a*(o-.06)),m.rotation.y=c,e.add(m),d};for(let e=0;e<4;e++){let t=Qe[e];r(yt,t.nx,t.nz,F.half,I[e].color)}let i=(2*F.half-F.chamfer)/Math.SQRT2,a=Math.SQRT1_2;for(let[e,t]of[[a,a],[a,-a],[-a,-a],[-a,a]])r(bt,e,t,i,3596543)}_buildBarriers(){this.fields=[];for(let e=0;e<4;e++){let t=Qe[e],n=new _t(yt,F.wallH*1.15,I[e].color);n.mesh.position.set(t.nx*(F.half-.06),F.wallH*.575,t.nz*(F.half-.06)),n.mesh.rotation.y=Math.atan2(t.nx,t.nz),n.setNormal(t.nx,0,t.nz),this.root.add(n.mesh),this.fields.push(n)}}_buildSubstructure(){let e=this.assets,t=new vt(this.mats),n=new M,r=(t,r,i,a,o=0,s=1,c=0)=>{let l=e.clone(t);return l.position.set(r,i,a),l.rotation.set(c,o,0),l.scale.setScalar(s),n.add(l),l},i=F.half+1.6;for(let e=0;e<40;e++){let t=e/40*Math.PI*2,n=i+K(-.4,.4),a=Math.cos(t)*n,o=Math.sin(t)*n;r(`platform_large`,a,-1.1+K(-.15,.15),o,t+Math.PI/2,1.6),e%3==0&&r(`supports_high`,a*1.06,-2.7,o*1.06,K(0,6.28),1.5),e%5==2&&r(`pipe_supportHigh`,a*1.13,-3.4,o*1.13,t,1.3)}for(let e=0;e<8;e++){let t=e/8*Math.PI*2+Math.PI/8;for(let e=2;e<13;e++)r(`platform_long`,Math.cos(t)*e*1.2,-2.2,Math.sin(t)*e*1.2,t+Math.PI/2,1.5);r(`machine_generatorLarge`,Math.cos(t)*8,-3,Math.sin(t)*8,t,1.6)}for(let e=0;e<22;e++){let e=K(0,Math.PI*2),t=K(3,F.half),n=K(-6.5,-3.2);r(`pipe_straight`,Math.cos(e)*t,n,Math.sin(e)*t,K(0,6.28),K(1.1,2))}t.add(n),t.build(this.root,{name:`substructure`,castShadow:!1,receiveShadow:!1})}_buildDressing(){let e=this.assets,t=new vt(this.mats),n=new M,r=(t,r,i,a,o=0,s=1)=>{let c=e.clone(t);return c.position.set(r,i,a),c.rotation.y=o,c.scale.setScalar(s),n.add(c),c},i=(2*F.half-F.chamfer)/Math.SQRT2;for(let e=0;e<4;e++){let t=Qe[e],n=Math.atan2(t.nx,t.nz),i=-t.nz,a=t.nx,o=F.half+J+.35;for(let e=0;e<9;e++){let s=(e/8-.5)*(yt-1.4),c=t.nx*o+i*s,l=t.nz*o+a*s;r(e%2?`structure`:`structure_detailed`,c,0,l,n,1.5),e%4==1&&r(`machine_wireless`,c+t.nx*1.3,1.5,l+t.nz*1.3,n,1.2)}let s=1.5,c=Math.ceil((yt+1)/s);for(let e=0;e<c;e++){let l=(e/(c-1)-.5)*(yt+1-s);r(`pipe_straight`,t.nx*(o+.5)+i*l,1.5,t.nz*(o+.5)+a*l,n+Math.PI/2,s)}}let a=Math.SQRT1_2;[[a,a],[a,-a],[-a,-a],[-a,a]].forEach(([e,t],n)=>{let a=Math.atan2(e,t),o=e*(i+J+1.1),s=t*(i+J+1.1);r(`pipe_ringHigh`,o,0,s,a,2.1),r(`supports_high`,o+e*1.4,0,s+t*1.4,a,2),r(`satelliteDish_large`,o+e*1.2,3,s+t*1.2,a+K(-.6,.6),2.4),r(`turret_double`,o-e*1.9,1.6,s-t*1.9,a+Math.PI,1.9),r(n%2?`barrels_rail`:`barrels`,o+e*2.6,0,s+t*2.6,K(0,6.28),1.7),r(`container-tall`,o-e*3.4+K(-1,1),0,s-t*3.4+K(-1,1),K(0,6.28),1.5)});let o=[[`hangar_roundA`,3.2],[`hangar_smallB`,3],[`rocket_baseA`,2.4],[`machine_generatorLarge`,3.4],[`hangar_roundA`,2.8],[`hangar_smallB`,3.4],[`machine_generatorLarge`,3],[`rocket_baseA`,2.2]],s=[`container`,`container-tall`,`display-wall`,`computer-wide`,`barrels`,`machine_generator`,`satelliteDish`];o.forEach(([e,t],n)=>{let i=n/o.length*Math.PI*2+Math.PI/8,a=F.half+13.5,c=Math.cos(i)*a,l=Math.sin(i)*a,u=Math.atan2(-c,-l);for(let e=-1;e<=1;e++)for(let t=-1;t<=1;t++){let n=Math.cos(u)*e*3.2-Math.sin(u)*t*3.2,i=Math.sin(u)*e*3.2+Math.cos(u)*t*3.2;r(`platform_large`,c+n,-1.2,l+i,u,1.6)}r(e,c,-1.0999999999999999,l,u,t);for(let e=0;e<5;e++){let t=u+K(-2.4,2.4),i=K(4.2,6.2);r(s[(n*3+e)%s.length],c+Math.cos(t)*i,-1.0999999999999999,l+Math.sin(t)*i,K(0,6.28),K(1.5,2.4))}r(`satelliteDish_large`,c+Math.cos(u+1.6)*5.4,-1.0999999999999999,l+Math.sin(u+1.6)*5.4,u+K(-.5,.5),2.6),r(`supports_high`,c,-3.8,l,u,3)});let c=F.half+26,l=Math.ceil(2*Math.PI*c/3);for(let e=0;e<l;e++){let t=e/l*Math.PI*2,n=Math.cos(t)*c,i=Math.sin(t)*c;r(`monorail_trackStraight`,n,-3,i,t+Math.PI/2,3),e%9==0&&r(`monorail_trackSupport`,n,-7.2,i,t+Math.PI/2,9)}let u=[`meteor`,`meteor_detailed`,`rock_largeA`,`rock_crystals`,`rock_crystalsLargeA`];for(let e=0;e<30;e++){let e=K(0,Math.PI*2),t=K(F.half+34,F.half+90);r(u[tt(0,u.length-1)],Math.cos(e)*t,K(-26,-6),Math.sin(e)*t,K(0,6.28),K(3,9))}t.add(n),this.dressMeshes=t.build(this.root,{name:`dressing`,castShadow:!1,receiveShadow:!1});for(let e of this.dressMeshes)e.name.endsWith(`:crystal`)&&(e.castShadow=!1)}_buildLights(){let e=new ie(12574975,1.75);if(e.position.set(16,30,14),e.target.position.set(0,0,0),this.preset.shadows){e.castShadow=!0;let t=F.half+4;e.shadow.mapSize.set(this.preset.shadowSize,this.preset.shadowSize),e.shadow.camera.left=-t,e.shadow.camera.right=t,e.shadow.camera.top=t,e.shadow.camera.bottom=-t,e.shadow.camera.near=8,e.shadow.camera.far=70,e.shadow.bias=-.0012,e.shadow.normalBias=.035,e.shadow.radius=2.2}this.root.add(e,e.target),this.keyLight=e;let t=new ie(16743070,.5);t.position.set(-22,8,-26),this.root.add(t);let n=new r(2779794,658968,.3);this.root.add(n);let i=new ie(13624063,.75);i.castShadow=!1,this.root.add(i,i.target),this.fillLight=i}goalHalfWidth(){return F.half-F.chamfer}hitBarrier(e,t,n){this.fields[e].hit(t,.32,n)}sealBarrier(e){this.fields[e].seal()}setBarrierHealth(e,t){this.fields[e].setHealth(t),this.floor.setTerritory(e,t)}shock(e,t,n,r){this.floor.addWave(e,t,n,r)}setCharge(e){this.floor.setCharge(e)}aimFill(e){this.fillLight&&this.fillLight.position.set(e.x*.55,e.y*.45+6,e.z*.55)}update(e,t){this.floor.update(e,t);for(let n of this.fields)n.update(e,t);this.railMat.emissiveIntensity=.78+Math.sin(t*1.1)*.14}dispose(){this.floor.dispose();for(let e of this.fields)e.dispose();this.root.traverse(e=>{e.isMesh&&e.geometry?.dispose()}),this.scene.remove(this.root)}},St=new O,Ct=class{constructor(e,t,n,r){this.index=e,this.def=t,this.side=Qe[e],this.nx=this.side.nx,this.nz=this.side.nz,this.tx=-this.side.nz,this.tz=this.side.nx,this.yaw=Math.atan2(this.nx,this.nz),this.halfLen=R.halfLen,this.halfThick=R.halfThick,this.limit=F.half-F.chamfer-this.halfLen*.42,this.u=0,this.vu=0,this.targetU=0,this.alive=!0,this.throttle=0,this.surge=1,this.surgeActive=0,this.arc=z.startCharge,this.arcActive=0,this.arcJustFired=!1,this.recoil=0,this.hitFlash=0,this.dying=0,this._dt=0,this.root=new M,this.root.name=`craft:${t.name}`,r.add(this.root),this._buildHull(n),this._buildDeflector(),this._buildThrusters(),this.sync(0)}_buildHull(e){this.mats=Fe(this.def.color,this.def.deep);let t=Ie(e.clone(this.def.craft),this.mats),n=new de().setFromObject(t),r=Math.max(.001,n.max.x-n.min.x),i=this.halfLen*2*.95/r;t.scale.setScalar(i),t.position.set(0,0,.62),t.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!0)}),this.hullPivot=new M,this.hullPivot.add(t),this.bobPivot=new M,this.bobPivot.add(this.hullPivot),this.root.add(this.bobPivot),this.hull=t}_buildDeflector(){let e=6.2,t=this.halfLen*2.06/e,n=new A(e,e,1.55,26,1,!0,Math.PI-t/2,t);n.translate(0,0,e),n.rotateY(0),this.defMat=new d({transparent:!0,depthWrite:!1,side:2,blending:2,uniforms:{uColor:{value:new k(this.def.color).convertSRGBToLinear()},uTime:{value:0},uHit:{value:0},uHitU:{value:.5},uSurge:{value:1},uAlive:{value:1}},vertexShader:`
        ...
        }`}),this.deflector=new p(n,this.defMat),this.deflector.position.set(0,.62,-.5),this.deflector.renderOrder=7,this.deflectorPivot=new M,this.deflectorPivot.add(this.deflector),this.root.add(this.deflectorPivot)}_buildThrusters(){this.thrustMat=new m({color:new k(this.def.color),transparent:!0,opacity:.9,blending:2,depthWrite:!1});let e=new fe(.19,1.5,10,1,!0);e.rotateX(Math.PI/2),e.translate(0,0,.75),this.thrusters=[];let t=this.halfLen*.44;for(let n of[-t,t]){let t=new p(e,this.thrustMat);t.position.set(n,.24,1.45),t.renderOrder=7,this.bobPivot.add(t),this.thrusters.push(t)}let n=new p(new ve(this.halfLen*.9,20),new m({color:new k(this.def.color),transparent:!0,opacity:.16,blending:2,depthWrite:!1}));n.rotation.x=-Math.PI/2,n.position.y=-.42,this.root.add(n),this.hoverGlow=n,this.glowMat=n.material}worldPos(e=St){let t=F.half-R.standoff-this.recoil;return e.set(this.nx*t+this.tx*this.u,F.playY,this.nz*t+this.tz*this.u)}get standoffDist(){return F.half-R.standoff-this.recoil}get effHalfLen(){return this.halfLen*(1+this.surgeActive*.42)}steer(e){this.targetU=U(e,-this.limit,this.limit)}trySurge(){return!this.alive||this.surge<1?!1:(this.surge=0,this.surgeActive=.55,!0)}tryArc(){return!this.alive||this.arc<1||this.arcActive>0?!1:(this.arc=0,this.arcActive=z.duration,this.arcJustFired=!0,!0)}get arcDist(){return F.half-R.standoff}onDeflect(e,t){this.defMat.uniforms.uHitU.value=e,this.defMat.uniforms.uHit.value=Math.min(1.4,this.defMat.uniforms.uHit.value+t),this.recoil=Math.min(.85,this.recoil+t*.5),this.hitFlash=1}onConcede(){this.hitFlash=1.6}eliminate(){this.alive&&(this.alive=!1,this.dying=.001)}update(e,t){if(this._dt=e,this.alive){let t=U((this.targetU-this.u)*R.track,-R.maxSpeed,R.maxSpeed),n=this.vu;this.vu=G(this.vu,t,R.damp,e),this.u=U(this.u+this.vu*e,-this.limit,this.limit),Math.abs(this.u)>=this.limit-1e-4&&(this.vu*=.35),this.accel=(this.vu-n)/Math.max(e,1e-4),this.throttle=G(this.throttle,Math.min(1,Math.abs(this.vu)/R.maxSpeed),9,e),this.surge=Math.min(1,this.surge+e/4.2),this.surgeActive=Math.max(0,this.surgeActive-e),this.arcActive=Math.max(0,this.arcActive-e),this.arcActive<=0&&(this.arc=Math.min(1,this.arc+e/z.cooldown))}else this.dying+=e,this.vu*=Math.exp(-e*2),this.u+=this.vu*e,this.arcActive=0;this.recoil=G(this.recoil,0,7.5,e),this.hitFlash=G(this.hitFlash,0,5.5,e);let n=this.defMat.uniforms;n.uTime.value=t,n.uHit.value*=Math.exp(-e*6.5),n.uSurge.value=G(n.uSurge.value,this.alive?this.surge:0,8,e),n.uAlive.value=G(n.uAlive.value,+!!this.alive,3,e),this.sync(t)}sync(e){let t=this.standoffDist;if(this.root.position.set(this.nx*t+this.tx*this.u,F.playY,this.nz*t+this.tz*this.u),this.root.rotation.y=this.yaw,this.alive){let t=-U(this.vu/R.maxSpeed,-1,1)*R.bankMax,n=U((this.accel||0)/900,-.22,.22),r=this._dt;this.hullPivot.rotation.z=G(this.hullPivot.rotation.z,t,11,r),this.hullPivot.rotation.x=G(this.hullPivot.rotation.x,n,9,r);let i=Math.sin(e*2.4+this.index*1.7)*R.hover+Math.sin(e*3.9+this.index)*R.hover*.35;this.bobPivot.position.y=i,this.bobPivot.rotation.z=Math.sin(e*1.6+this.index*2.1)*.035;let a=.25+this.throttle*1.5+this.hitFlash*.8;for(let e of this.thrusters)e.scale.set(1+this.throttle*.35,1,a);this.thrustMat.opacity=.35+this.throttle*.55,this.hoverGlow.material.opacity=.1+this.throttle*.14;let o=this.mats.metalRed;o.emissiveIntensity=2.2+this.hitFlash*5+this.surge*.7}else{let e=this.dying,t=this._dt*60;this.hullPivot.rotation.z+=.055*t,this.hullPivot.rotation.x+=.031*t,this.bobPivot.position.y=-e*e*3.2;let n=Math.max(0,1-e*.85);this.thrustMat.opacity=n*.2,this.hoverGlow.material.opacity=n*.04,this.mats.metalRed.emissiveIntensity=n*1.2;for(let e of this.thrusters)e.scale.set(1,1,n*.4);e>2.4&&(this.root.visible=!1)}let n=1+this.surgeActive*.42;this.deflector.scale.set(n,1,n)}dispose(){this.root.traverse(e=>{e.isMesh&&e.geometry?.dispose()});for(let e of Object.values(this.mats))e.dispose();this.defMat.dispose(),this.thrustMat.dispose(),this.glowMat.dispose(),this.root.parent?.remove(this.root)}},wt=`
attribute vec3 aDir;
...
}`,Mt=null;function Nt(){return Mt||(Mt={core:new be(B.radius*.82,3),shell:new be(B.radius*1.16,3),glow:new f(2,2)}),Mt}var Pt=class{constructor(e,t,n){this.scene=e,this.active=!1,this.x=0,this.z=0,this.vx=0,this.vz=0,this.speed=B.baseSpeed,this.lastHitBy=-1,this.rally=0,this.age=0,this.impact=0,this.impactDirX=1,this.impactDirZ=0;let r=Nt();this.root=new M;let i=new k(7333631),a=new k(16777215);this.coreMat=new d({vertexShader:Dt,fragmentShader:Ot,uniforms:{uColor:{value:i.clone().convertSRGBToLinear()},uHot:{value:a.clone().convertSRGBToLinear()},uTime:{value:0},uEnergy:{value:0}}}),this.core=new p(r.core,this.coreMat),this.core.castShadow=!1,this.shellMat=new d({vertexShader:Dt,fragmentShader:kt,uniforms:{uColor:{value:i.clone().convertSRGBToLinear()},uTime:{value:0},uEnergy:{value:0}},transparent:!0,depthWrite:!1,blending:2,side:2}),this.shell=new p(r.shell,this.shellMat),this.glowMat=new d({vertexShader:At,fragmentShader:jt,uniforms:{uColor:{value:i.clone().convertSRGBToLinear()},uSize:{value:B.radius*4.6},uIntensity:{value:1}},transparent:!0,depthWrite:!1,blending:2}),this.glow=new p(r.glow,this.glowMat),this.glow.frustumCulled=!1,this.glow.renderOrder=10,this.squash=new M,this.squash.add(this.core,this.shell),this.root.add(this.squash,this.glow),this.trail=new Et(t.trailSegments,3066111,16777215,B.radius*.86),e.add(this.trail.mesh),n&&(this.light=new v(7333631,12,16,2),this.root.add(this.light)),this.blob=new p(new f(B.radius*6,B.radius*6),new d({transparent:!0,depthWrite:!1,blending:2,uniforms:{uColor:{value:i.clone().convertSRGBToLinear()}},vertexShader:`varying vec2 vU; void main(){ vU=uv; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }`,fragmentShader:`precision mediump float; varying vec2 vU; uniform vec3 uColor;
          void main(){ vec2 p=(vU-0.5)*2.0; float r2=dot(p,p);
            if(r2>1.0) discard; float a=exp(-r2*4.5)*0.42;
            gl_FragColor=vec4(uColor*a,a); }`})),this.blob.rotation.x=-Math.PI/2,this.blob.renderOrder=3,this.root.add(this.blob),e.add(this.root),this.setVisible(!1)}setVisible(e){this.root.visible=e,this.trail.mesh.visible=e}setTint(e){let t=new k(e),n=t.clone().convertSRGBToLinear();this.coreMat.uniforms.uColor.value.copy(n),this.shellMat.uniforms.uColor.value.copy(n),this.glowMat.uniforms.uColor.value.copy(n),this.blob.material.uniforms.uColor.value.copy(n),this.trail.setColor(e,16777215),this.light&&this.light.color.copy(t)}spawn(e,t,n,r){this.active=!0,this.x=e,this.z=t,this.speed=r,this.vx=Math.sin(n)*r,this.vz=Math.cos(n)*r,this.lastHitBy=-1,this.rally=0,this.age=0,this.impact=0,this.setTint(7333631),this.root.position.set(e,F.playY,t),this.trail.reset(e,F.playY,t),this.setVisible(!0)}kill(){this.active=!1,this.setVisible(!1)}registerImpact(e,t,n=1){this.impact=Math.min(1.5,this.impact+n),this.impactDirX=e,this.impactDirZ=t}updateVisual(e,t){if(!this.active)return;this.age+=e;let n=U((this.speed-B.baseSpeed)/(B.maxSpeed-B.baseSpeed),0,1);this.impact=G(this.impact,0,9,e),this.root.position.set(this.x,F.playY,this.z);let r=1/Math.max(1e-4,Math.hypot(this.vx,this.vz)),i=this.vx*r,a=this.vz*r,o=1+n*.28+this.impact*.34,s=1/Math.sqrt(o);this.squash.quaternion.setFromUnitVectors(Ft,It.set(i,0,a)),this.squash.scale.set(s,s,o);let c=n*.7+this.impact*.5;this.coreMat.uniforms.uTime.value=t,this.coreMat.uniforms.uEnergy.value=c,this.shellMat.uniforms.uTime.value=t,this.shellMat.uniforms.uEnergy.value=c,this.glowMat.uniforms.uIntensity.value=.85+n*.7+this.impact*1.1,this.glowMat.uniforms.uSize.value=B.radius*(4.4+n*1.5+this.impact*2.2),this.light&&(this.light.intensity=9+n*10+this.impact*22),this.blob.position.set(0,-F.playY+.035,0);let l=1+n*.35;this.blob.scale.set(l,l,1),this.trail.push(this.x,F.playY,this.z),this.trail.setWidth(B.radius*(.8+n*.5))}dispose(){this.coreMat.dispose(),this.shellMat.dispose(),this.glowMat.dispose(),this.blob.geometry.dispose(),this.blob.material.dispose(),this.trail.dispose(),this.scene.remove(this.root,this.trail.mesh)}},Ft=new O(0,0,1),It=new O,Lt=.22;function Rt(e,t,n,r,i){let a=e*-r+t*n,o=e*-n+t*-r,s=Math.sin(B.minAngle)*i;if(o>=s)return[e,t];let c=a>=0?1:-1,l=s,u=c*Math.sqrt(Math.max(0,i*i-l*l));return[-r*u+-n*l,n*u+-r*l]}function zt(e,t,n){let{planes:r,crafts:i,bricks:a,pinball:o,events:s}=n,c=t,l=0;for(;c>1e-6&&l++<64;){let t=Math.hypot(e.vx,e.vz)||1e-4,n=Math.min(c,Lt/t);if(c-=n,e.x+=e.vx*n,e.z+=e.vz*n,t>B.cruise){let r=Math.max(B.cruise,t-B.bleed*n),i=r/t;e.vx*=i,e.vz*=i,e.speed=r}for(let n of i){if(!n.alive||n.arcActive<=0)continue;let r=e.vx*n.nx+e.vz*n.nz;if(r<=0)continue;let i=n.arcDist,a=e.x*n.nx+e.z*n.nz-i;if(a+B.radius<0||a>B.radius)continue;let o=e.x*n.tx+e.z*n.tz,c=F.half-F.chamfer;if(Math.abs(o)>c)continue;e.vx-=2*r*n.nx,e.vz-=2*r*n.nz;let l=U(n.vu/R.maxSpeed,-1,1)*z.english;e.vx+=n.tx*l*t,e.vz+=n.tz*l*t;let u=Math.min(B.maxSpeed,t+z.speedGain),[d,f]=Rt(e.vx,e.vz,n.nx,n.nz,u),p=Math.hypot(d,f)||1;e.vx=d/p*u,e.vz=f/p*u,e.speed=u;let m=a+B.radius+.02;e.x-=n.nx*m,e.z-=n.nz*m,e.registerImpact(-n.nx,-n.nz,1.1),s.push({type:`arc`,orb:e,craft:n,speed:u,x:e.x,z:e.z,u01:U(o/c,-1,1)*.5+.5});break}for(let n of i){if(!n.alive||e.vx*n.nx+e.vz*n.nz<=0)continue;let r=n.standoffDist,i=e.x-n.nx*r-n.tx*n.u,a=e.z-n.nz*r-n.tz*n.u,o=i*n.tx+a*n.tz,c=i*n.nx+a*n.nz;if(c>0)continue;let l=n.effHalfLen,u=U(o,-l,l),d=U(c,-n.halfThick,n.halfThick),f=o-u,p=c-d;if(f*f+p*p>B.radius*B.radius)continue;let m=U(o/l,-1,1),h=U(n.vu/R.maxSpeed,-1,1)*B.spinInfluence,g=m*B.angleInfluence+h;g=U(g,-1.35,1.35);let _=g,v=-1,y=1/Math.hypot(_,v);_*=y,v*=y;let b=+(n.surgeActive>0),x=Math.min(B.maxSpeed,t+B.rallyGain+B.paddleBoost+b*3.4);e.vx=(n.tx*_+n.nx*v)*x,e.vz=(n.tz*_+n.nz*v)*x,e.speed=x,e.rally++,e.lastHitBy=n.index;let ee=B.radius+n.halfThick+.02;e.x=n.nx*r+n.tx*n.u+n.tx*u-n.nx*ee,e.z=n.nz*r+n.tz*n.u+n.tz*u-n.nz*ee,e.registerImpact(-n.nx,-n.nz,.85+b*.5),s.push({type:`deflect`,orb:e,craft:n,u01:(m+1)*.5,power:.7+b*.6,speed:x,x:e.x,z:e.z});break}a&&a.collide(e,s),o&&o.collide(e,s);for(let t of r){let n=e.x*t.nx+e.z*t.nz;if(n+B.radius<=t.d)continue;if(t.goal>=0){let n=e.x*-t.nz+e.z*t.nx,r=i[t.goal];if(r.alive&&r.arcActive<=0&&Math.abs(n)<=t.halfWidth){e.active=!1,s.push({type:`goal`,orb:e,victim:t.goal,x:e.x,z:e.z,u01:U(n/t.halfWidth,-1,1)*.5+.5});return}}let r=n+B.radius-t.d;e.x-=t.nx*r*1.02,e.z-=t.nz*r*1.02;let a=e.vx*t.nx+e.vz*t.nz;a>0&&(e.vx-=2*a*t.nx,e.vz-=2*a*t.nz);let o=Math.min(B.maxSpeed,Math.hypot(e.vx,e.vz)+B.rallyGain*.35),[c,l]=Rt(e.vx,e.vz,t.nx,t.nz,o),u=Math.hypot(c,l)||1;e.vx=c/u*o,e.vz=l/u*o,e.speed=o,e.registerImpact(-t.nx,-t.nz,.55),s.push({type:t.goal>=0?`sealed`:`wall`,orb:e,x:e.x,z:e.z,nx:t.nx,nz:t.nz,speed:o,goal:t.goal});break}}}function Bt(e,t){let n=B.radius*2*(B.radius*2);for(let r=0;r<e.length;r++){let i=e[r];if(i.active)for(let a=r+1;a<e.length;a++){let r=e[a];if(!r.active)continue;let o=r.x-i.x,s=r.z-i.z,c=o*o+s*s;if(c>n||c<1e-8)continue;let l=Math.sqrt(c);o/=l,s/=l;let u=(r.vx-i.vx)*o+(r.vz-i.vz)*s;if(u<0){i.vx+=u*o,i.vz+=u*s,r.vx-=u*o,r.vz-=u*s;let e=Math.hypot(i.vx,i.vz)||1,n=Math.hypot(r.vx,r.vz)||1;i.vx=i.vx/e*i.speed,i.vz=i.vz/e*i.speed,r.vx=r.vx/n*r.speed,r.vz=r.vz/n*r.speed,i.registerImpact(-o,-s,.6),r.registerImpact(o,s,.6),t.push({type:`orbclash`,x:i.x+o*B.radius,z:i.z+s*B.radius,speed:Math.max(i.speed,r.speed)})}let d=(B.radius*2-l)*.5+.001;i.x-=o*d,i.z-=s*d,r.x+=o*d,r.z+=s*d}}}function Vt(e,t,n,r=4){let i=e.x,a=e.z,o=e.vx,s=e.vz,c=t[n],l=0;for(let e=0;e<10&&l<r;e++){let e=1/0,n=null;for(let r of t){let t=o*r.nx+s*r.nz;if(t<=1e-6)continue;let c=(r.d-B.radius-(i*r.nx+a*r.nz))/t;c>1e-5&&c<e&&(e=c,n=r)}if(!n||!isFinite(e))return null;if(l+=e,i+=o*e,a+=s*e,n===c)return{lateral:i*-c.nz+a*c.nx,time:l};let r=o*n.nx+s*n.nz;o-=2*r*n.nx,s-=2*r*n.nz}return null}var Ht=class{constructor(e,t,n){this.craft=e,this.diff=t,this.planes=n,this.reactTimer=0,this.aimError=0,this.desiredU=0,this.threatId=-1,this.victim=-1,this.idlePhase=K(0,Math.PI*2),this.commitTime=0,this.panic=0}_pickVictim(e,t){let n=this.craft.index,r=[];for(let i=0;i<4;i++){if(i===n||!e[i].alive)continue;let a=1+(6-t[i])*.45;i===0&&(a*=1+this.diff.aggression*.15),i===this.victim&&(a*=.45),r.push([i,a])}if(!r.length)return-1;let i=0;for(let[,e]of r)i+=e;let a=Math.random()*i;for(let[e,t]of r)if(a-=t,a<=0)return e;return r[0][0]}_aimOffset(e,t){let n=this.craft;if(e<0)return 0;let r=Qe[e],i=K(-.55,.55)*(F.half-F.chamfer),a=-r.nz,o=r.nx,s=r.nx*F.half+a*i,c=r.nz*F.half+o*i,l=n.standoffDist,u=n.nx*l+n.tx*t,d=n.nz*l+n.tz*t,f=s-u,p=c-d,m=f*n.tx+p*n.tz,h=f*-n.nx+p*-n.nz;return h<=.5?0:U(U(m/h,-1.2,1.2)/B.angleInfluence,-.92,.92)}update(e,t,n,r){let i=this.craft;if(!i.alive)return;let a=null,o=null;for(let e of t){if(!e.active)continue;let t=Vt(e,this.planes,i.index,5);t&&(!a||t.time<a.time)&&(a=t,o=e)}if(this.reactTimer-=e,a){(o.id!==this.threatId||a.time>this.commitTime+.35)&&this.reactTimer<=0&&(this.threatId=o.id,this.reactTimer=this.diff.react*K(.7,1.35),this.victim=this._pickVictim(n,r),this.aimError=K(-1,1)*this.diff.err*K(.6,1.4)),this.commitTime=a.time;let t=this._aimOffset(this.victim,a.lateral)*i.halfLen,s=U(1-a.time/1.6,0,1),c=this.aimError*(1-s*.82);if(this.desiredU=a.lateral-t+c,this.panic=U(Math.abs(a.lateral-i.u)/8*(1-a.time/1.2),0,1),this.panic>.55&&a.time<.55&&i.surge>=1&&Math.random()<this.diff.aggression*e*22&&i.trySurge(),i.arc>=1&&a.time<1.1){let e=i.halfLen+R.maxSpeed*this.diff.speed*a.time;(Math.abs(a.lateral-i.u)>e||r[this.craft.index]<=1)&&i.tryArc()}}else{this.idlePhase+=e*.55;let t=Math.sin(this.idlePhase)*(F.half-F.chamfer)*.3;this.desiredU=W(this.desiredU,t,1-Math.exp(-e*1.6)),this.panic=0}let s=R.maxSpeed*this.diff.speed*(1+this.panic*.25),c=i.targetU,l=U(this.desiredU-c,-s*e,s*e);i.steer(c+l)}},Ut=`
attribute float aSize;
...
void main() {
  ...
  gl_FragColor = vec4(vColor * a * 2.6, a);
          ...
          {
            float y = vLocal.y / ${H.bumperH.toFixed(3)};
            float rad = length(vLocal.xz) / ${H.bumperR.toFixed(3)};
          ...
          }`)},n.customProgramCacheKey=()=>`bumper-body`,this.bodyMat=n,this.body=new a(this.bodyGeo,n,e),this._attr(this.bodyGeo,`aState`,this.bumperState,2),this.body.castShadow=!1,this.body.receiveShadow=!0,this.body.frustumCulled=!1,this.body.name=`bumpers`,this.crownGeo=new A(H.bumperR*1.06,H.bumperR*.94,.26,22,1,!0),this.crownGeo.translate(0,H.bumperH*.93,0),this.crownMat=new d({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:this._time},vertexShader:`
        attribute vec2 aState;
        ...
        void main() {
        ...
        }`}),this.crown=new a(this.crownGeo,this.crownMat,e),this._attr(this.crownGeo,`aState`,this.bumperState,2),this.crown.frustumCulled=!1,this.crown.renderOrder=6,this.slingGeo=Yt(H.slingHalf,H.slingDepth,H.slingH);let r=new g({color:1252135,metalness:.9,roughness:.36,envMapIntensity:.5});r.onBeforeCompile=e=>{e.uniforms.uTime=this._time,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
          attribute vec2 aState;
          varying vec2 vState; varying vec3 vLocal;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
          vState = aState; vLocal = position;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
          uniform float uTime;
          varying vec2 vState; varying vec3 vLocal;`).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
          {
            ...
            float y = vLocal.y / ${H.slingH.toFixed(3)};
          ...
          }`)},r.customProgramCacheKey=()=>`sling-body`,this.slingMat=r,this.sling=new a(this.slingGeo,r,t),this._attr(this.slingGeo,`aState`,this.slingState,2),this.sling.castShadow=!1,this.sling.receiveShadow=!0,this.sling.frustumCulled=!1,this.sling.name=`slings`,this._placeInstances(),this.scene.add(this.body,this.crown,this.sling)}_attr(e,t,n,r){let i=new b(n,r);return i.setUsage(C),e.setAttribute(t,i),this._attrs.push(i),i}_placeInstances(){let e=new oe,t=new n,r=new O,i=new O(1,1,1),a=new O(0,1,0);this.bumpers.forEach((n,o)=>{r.set(n.x,F.floorY,n.z),t.setFromAxisAngle(a,n.seed*Math.PI),e.compose(r,t,i),this.body.setMatrixAt(o,e),this.crown.setMatrixAt(o,e),this.bumperState[o*2+1]=n.seed}),this.slings.forEach((n,o)=>{r.set(n.x,F.floorY,n.z),t.setFromAxisAngle(a,Math.atan2(-n.nx,-n.nz)),e.compose(r,t,i),this.sling.setMatrixAt(o,e),this.slingState[o*2+1]=n.seed}),this.body.instanceMatrix.needsUpdate=!0,this.crown.instanceMatrix.needsUpdate=!0,this.sling.instanceMatrix.needsUpdate=!0}reset(){for(let e of this.bumpers)e.flash=0,e.cool=0;for(let e of this.slings)e.flash=0,e.cool=0;this.phase=Xt,this.timer=H.downTime,this.lift=-2,this._warned=!1,this.justDeployed=!1,this.justRetracted=!1,this.justWarned=!1,this._applyLift()}get live(){return this.phase===Qt}get cycle01(){return this.phase===Qt?U(this.timer/H.upTime,0,1):this.phase===Xt?U(1-this.timer/H.downTime,0,1):+(this.phase===Zt)}_applyLift(){let e=this.lift,t=e<=-1.999;for(let n of[this.body,this.crown,this.sling])n.position.y=e,n.visible=!t}_cycle(e){switch(this.justDeployed=!1,this.justRetracted=!1,this.justWarned=!1,this.timer-=e,this.phase){case Xt:this.timer<=H.warnTime&&!this._warned&&(this._warned=!0,this.justWarned=!0),this.timer<=0&&(this.phase=Zt,this.timer=H.riseTime,this._warned=!1,this.justDeployed=!0);break;case Zt:this.timer<=0&&(this.phase=Qt,this.timer=H.upTime);break;case Qt:this.timer<=0&&(this.phase=$t,this.timer=H.riseTime,this.justRetracted=!0);break;case $t:this.timer<=0&&(this.phase=Xt,this.timer=H.downTime)}let t=1;this.phase===Xt?t=0:this.phase===Zt?t=1-U(this.timer/H.riseTime,0,1):this.phase===$t&&(t=U(this.timer/H.riseTime,0,1));let n=this.phase===Zt?1-(1-t)**3:t;this.lift=-2*(1-n),this._applyLift()}collide(e,t){if(this.phase!==Qt)return!1;let n=B.radius;for(let r of this.bumpers){if(r.cool>0)continue;let i=e.x-r.x,a=e.z-r.z,o=r.r+n,s=i*i+a*a;if(s>o*o)continue;let c=Math.sqrt(s),l,u;if(c>1e-5)l=i/c,u=a/c;else{let t=Math.hypot(e.vx,e.vz)||1;l=-e.vx/t,u=-e.vz/t}let d=Math.hypot(e.vx,e.vz)||1,f=(e.vx*l+e.vz*u)/d,p=e.vx/d-2*f*l,m=e.vz/d-2*f*u,h=p*.42+l*.72,g=m*.42+u*.72,_=Math.atan2(g,h)+K(-H.scatter,H.scatter),v=U(d+H.kick,H.kickFloor,B.maxSpeed);return e.vx=Math.cos(_)*v,e.vz=Math.sin(_)*v,e.speed=v,e.x=r.x+l*(o+.02),e.z=r.z+u*(o+.02),e.registerImpact(-l,-u,1),r.flash=1,r.cool=H.cool,t.push({type:`bumper`,x:e.x,z:e.z,nx:l,nz:u,speed:v,el:r}),!0}for(let r of this.slings){let i=e.x-r.x,a=e.z-r.z,o=i*r.nx+a*r.nz,s=i*r.tx+a*r.tz;if(o<-r.depth-n||o>n||Math.abs(s)>r.half+n)continue;let c=U(o,-r.depth,0),l=U(s,-r.half,r.half),u=o-c,d=s-l,f=u*u+d*d,p,m,h;if(f>1e-8){if(f>n*n)continue;let e=Math.sqrt(f);p=u/e,m=d/e,h=n-e+.02}else{let e=-o,t=o+r.depth,i=r.half-Math.abs(s);e<=t&&e<=i?(p=1,m=0,h=e+n+.02):t<=i?(p=-1,m=0,h=t+n+.02):(p=0,m=Math.sign(s)||1,h=i+n+.02)}let g=r.nx*p+r.tx*m,_=r.nz*p+r.tz*m,v=e.vx*g+e.vz*_<0;if(e.x+=g*h,e.z+=_*h,p>.5&&v&&r.cool<=0){let n=U(s/r.half,-1,1),i=r.nx+r.tx*n*H.slingSpread,a=r.nz+r.tz*n*H.slingSpread,o=Math.hypot(i,a)||1,c=H.slingSpeed;return e.vx=i/o*c,e.vz=a/o*c,e.speed=c,e.registerImpact(-r.nx,-r.nz,1.3),r.flash=1,r.cool=H.cool,t.push({type:`sling`,x:e.x,z:e.z,nx:r.nx,nz:r.nz,speed:c,u01:n*.5+.5,el:r}),!0}if(v){let n=e.vx*g+e.vz*_;return e.vx-=2*n*g,e.vz-=2*n*_,e.registerImpact(-g,-_,.5),t.push({type:`wall`,orb:e,x:e.x,z:e.z,nx:g,nz:_,speed:e.speed,goal:-1}),!0}return!1}return!1}update(e,t){this._time&&(this._time.value=t),this._cycle(e);for(let t=0;t<this.bumpers.length;t++){let n=this.bumpers[t];n.cool=Math.max(0,n.cool-e),n.flash=Math.max(0,n.flash-e*3.6),this.bumperState[t*2]=n.flash}for(let t=0;t<this.slings.length;t++){let n=this.slings[t];n.cool=Math.max(0,n.cool-e),n.flash=Math.max(0,n.flash-e*3),this.slingState[t*2]=n.flash}for(let e of this._attrs)e.needsUpdate=!0}dispose(){this.bodyGeo.dispose(),this.crownGeo.dispose(),this.slingGeo.dispose(),this.bodyMat.dispose(),this.crownMat.dispose(),this.slingMat.dispose(),this.scene.remove(this.body,this.crown,this.sling)}},tn=H.warnTime,nn=class{constructor(e,t=10){this.items=[];let n=new x(.78,1,48,1);n.rotateX(-Math.PI/2),this.geo=n;for(let r=0;r<t;r++){let t=new d({transparent:!0,depthWrite:!1,blending:2,side:2,uniforms:{uColor:{value:new k(1,1,1)},uFade:{value:0}},vertexShader:`varying vec2 vU; void main(){ vU=uv;
          ...
          }`}),r=new p(n,t);r.visible=!1,r.renderOrder=5,e.add(r),this.items.push({mesh:r,mat:t,life:0,dur:1,from:1,to:6,tilt:0})}this.cursor=0}spawn(e,t,n,r,i,a,o,s=0,c=0){let l=this.items.find(e=>e.life<=0);return l||(l=this.items[this.cursor],this.cursor=(this.cursor+1)%this.items.length),l.life=a,l.dur=a,l.from=r,l.to=i,l.tilt=s,l.mesh.position.set(e,t,n),l.mesh.rotation.set(s,c,0),l.mesh.visible=!0,l.mat.uniforms.uColor.value.set(o).convertSRGBToLinear(),l.mat.uniforms.uFade.value=1,l}update(e){for(let t of this.items){if(t.life<=0)continue;if(t.life-=e,t.life<=0){t.mesh.visible=!1;continue}let n=1-t.life/t.dur,r=1-(1-n)**2.6,i=W(t.from,t.to,r);t.mesh.scale.set(i,i,i),t.mat.uniforms.uFade.value=(1-n)**1.7}}dispose(){this.geo.dispose();for(let e of this.items)e.mat.dispose(),e.mesh.parent?.remove(e.mesh)}},rn=class{constructor(e,t,n,r,i){this.scene=e,this.arena=t,this.cam=n,this.audio=r,this.preset=i,this.sparks=new Gt(i.sparks,Math.min(devicePixelRatio||1,2)),e.add(this.sparks.points),this.rings=new nn(e,i.sparks>400?12:7),this.flash=0,this.flashColor=new k(1,1,1),this.radial=0}setPixelRatio(e){this.sparks.setPixelRatio(e)}update(e,t){this.sparks.update(e,t),this.rings.update(e),this.flash=Math.max(0,this.flash-e*4.2),this.radial=Math.max(0,this.radial-e*3.4)}deflect(e){let t=e.craft,n=I[t.index],r=U((e.speed-15)/25,0,1),i=-t.nx,a=-t.nz;this.sparks.burst({at:[e.x,F.playY,e.z],dir:[i,.35,a],spread:.62,count:Math.round(W(8,20,r)*(this.preset.sparks/520+.4)),speedMin:6,speedMax:16+r*14,lifeMin:.16,lifeMax:.42,sizeMin:5,sizeMax:13,color:n.color,color2:16777215,kind:1,drag:3.4,grav:-7,jitter:.3}),this.rings.spawn(e.x,F.playY-.75,e.z,.25,2.4+r*1.6,.42,n.color),this.arena.shock(e.x,e.z,.55+r*.5,n.color),this.arena.hitBarrier(t.index,e.u01,.18),t.onDeflect(e.u01,e.power),this.audio.deflect(r,.75+e.power*.35,t.index/3),t.index===0?(this.cam.shake(.09+r*.1),this.cam.punch(.7+r*.9)):this.cam.shake(.035+r*.03)}wall(e){let t=U((e.speed-15)/25,0,1),n=e.goal>=0?16754237:6281471;this.sparks.burst({at:[e.x,F.playY,e.z],dir:[-e.nx,.5,-e.nz],spread:.75,count:Math.round(W(4,11,t)*(this.preset.sparks/520+.4)),speedMin:4,speedMax:11+t*8,lifeMin:.12,lifeMax:.34,sizeMin:4,sizeMax:9,color:n,color2:16777215,kind:1,drag:4.2,grav:-8}),this.arena.shock(e.x,e.z,.28+t*.3,n),this.audio.wall(t),this.cam.shake(.02+t*.03)}orbClash(e){(e.speed-15)/25,this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(16*(this.preset.sparks/520+.4)),speedMin:5,speedMax:15,lifeMin:.2,lifeMax:.5,sizeMin:4,sizeMax:11,color:16777215,color2:8382719,kind:0,drag:3,grav:-6}),this.rings.spawn(e.x,F.playY,e.z,.2,2.6,.4,12578815,-Math.PI/2),this.arena.shock(e.x,e.z,.5,12578815),this.audio.clash(),this.cam.shake(.07)}goal(e,t){let n=I[e.victim],r=this.preset.sparks;this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(46*(r/520+.5)),speedMin:8,speedMax:30,lifeMin:.3,lifeMax:.95,sizeMin:6,sizeMax:20,color:n.color,color2:16777215,kind:1,drag:2.2,grav:-11,jitter:.6}),this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(22*(r/520+.5)),speedMin:3,speedMax:12,lifeMin:.5,lifeMax:1.4,sizeMin:10,sizeMax:26,color:n.color,color2:16747082,kind:0,drag:1.6,grav:-2.5});let i=this.arena.planes[e.victim];this.rings.spawn(e.x,F.playY,e.z,.4,7,.7,n.color,0,Math.atan2(i.nx,i.nz)),this.rings.spawn(e.x,F.playY-.8,e.z,.4,11,.85,n.color),this.arena.shock(e.x,e.z,2,n.color),this.arena.hitBarrier(e.victim,e.u01,1.4),this.flash=t?.42:.2,this.flashColor.set(n.color).convertSRGBToLinear().lerp(new k(1,1,1),.55),this.radial=t?1.5:.7,this.audio.goal(t),this.cam.shake(t?.62:.34),this.cam.punch(t?5.5:3),this.cam.kick(-i.nx,-i.nz,t?.55:.3)}eliminate(e){let t=I[e.index],n=e.worldPos(new O),r=this.preset.sparks;this.sparks.burst({at:[n.x,n.y,n.z],spread:2,count:Math.round(90*(r/520+.5)),speedMin:10,speedMax:42,lifeMin:.4,lifeMax:1.3,sizeMin:7,sizeMax:24,color:t.color,color2:16777215,kind:1,drag:1.8,grav:-13,jitter:1.2}),this.sparks.burst({at:[n.x,n.y,n.z],spread:2,count:Math.round(40*(r/520+.5)),speedMin:4,speedMax:18,lifeMin:.8,lifeMax:2.2,sizeMin:14,sizeMax:40,color:16742954,color2:4199946,kind:0,drag:1.1,grav:-1.4,jitter:1.4}),this.sparks.burst({at:[n.x,n.y,n.z],spread:2,count:Math.round(26*(r/520+.5)),speedMin:6,speedMax:26,lifeMin:.9,lifeMax:2,sizeMin:8,sizeMax:18,color:10466249,color2:t.color,kind:2,drag:.9,grav:-16,jitter:1}),this.rings.spawn(n.x,F.playY-.8,n.z,.5,17,1.15,t.color),this.rings.spawn(n.x,F.playY,n.z,.5,9,.8,16777215,0,Math.atan2(e.nx,e.nz)),this.arena.shock(n.x,n.z,3,t.color),this.arena.sealBarrier(e.index),this.flash=.62,this.flashColor.set(16765088).convertSRGBToLinear(),this.radial=2.2,this.audio.explode(),this.cam.shake(.95),this.cam.punch(7)}arcIgnite(e){let t=I[e.index],n=this.preset.sparks,r=e.arcDist,i=F.half-F.chamfer,a=Math.round(14*(n/520+.5));for(let n=0;n<a;n++){let o=(n/(a-1)-.5)*2*i;this.sparks.burst({at:[e.nx*r+e.tx*o,F.playY+K(-.2,1.4),e.nz*r+e.tz*o],dir:[-e.nx,.5,-e.nz],spread:.85,count:3,speedMin:3,speedMax:13,lifeMin:.14,lifeMax:.5,sizeMin:4,sizeMax:12,color:16777215,color2:t.color,kind:1,drag:3.6,grav:-5,jitter:.5})}let o=e.worldPos(new O);this.rings.spawn(o.x,F.playY-.8,o.z,.4,9,.6,t.color),this.rings.spawn(o.x,F.playY,o.z,.3,5,.45,16777215,0,Math.atan2(e.nx,e.nz)),this.arena.shock(o.x,o.z,1.5,t.color),this.flash=e.index===0?.34:.16,this.flashColor.set(14217471).convertSRGBToLinear(),this.audio.arcOn(),this.cam.shake(e.index===0?.34:.16),this.cam.punch(e.index===0?3.2:1.4)}arcStrike(e){let t=e.craft,n=I[t.index],r=U((e.speed-15)/20,0,1);this.sparks.burst({at:[e.x,F.playY,e.z],dir:[-t.nx,.45,-t.nz],spread:.55,count:Math.round(W(14,28,r)*(this.preset.sparks/520+.4)),speedMin:8,speedMax:24+r*14,lifeMin:.12,lifeMax:.4,sizeMin:5,sizeMax:14,color:16777215,color2:n.color,kind:1,drag:3.2,grav:-8,jitter:.4}),this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(6*(this.preset.sparks/520+.4)),speedMin:1,speedMax:5,lifeMin:.4,lifeMax:.9,sizeMin:8,sizeMax:18,color:n.color,color2:10475775,kind:0,drag:2.2,grav:-1.5}),this.rings.spawn(e.x,F.playY-.78,e.z,.2,3.4,.4,16777215),this.arena.shock(e.x,e.z,.8+r*.5,n.color),this.audio.arcHit(r),this.cam.shake(t.index===0?.16:.05),t.index===0&&this.cam.punch(1.1)}arcCrackle(e,t){if(this._crackle=(this._crackle||0)+t*26,this._crackle<1)return;this._crackle=0;let n=I[e.index],r=e.arcDist,i=F.half-F.chamfer,a=K(-i,i);this.sparks.burst({at:[e.nx*r+e.tx*a,F.playY+K(-.3,1.5),e.nz*r+e.tz*a],dir:[-e.nx,.3,-e.nz],spread:1.1,count:1,speedMin:2,speedMax:9,lifeMin:.1,lifeMax:.32,sizeMin:3,sizeMax:9,color:16777215,color2:n.color,kind:1,drag:4,grav:-6})}arcExpire(e){let t=I[e.index],n=e.worldPos(new O);this.rings.spawn(n.x,F.playY-.8,n.z,6,.5,.4,t.color),this.audio.arcOff()}brickHit(e){let t=U((e.speed-12)/20,0,1);this.sparks.burst({at:[e.x,F.playY,e.z],dir:[e.nx,.55,e.nz],spread:.7,count:Math.round(W(4,10,t)*(this.preset.sparks/520+.4)),speedMin:4,speedMax:12+t*9,lifeMin:.12,lifeMax:.34,sizeMin:4,sizeMax:10,color:e.tint,color2:16777215,kind:1,drag:4,grav:-9,jitter:.35}),this.sparks.burst({at:[e.x,F.playY,e.z],dir:[e.nx,.8,e.nz],spread:1,count:Math.round(3*(this.preset.sparks/520+.4)),speedMin:3,speedMax:9,lifeMin:.4,lifeMax:.8,sizeMin:5,sizeMax:10,color:10466249,color2:e.tint,kind:2,drag:1.4,grav:-15}),this.arena.shock(e.x,e.z,.22+t*.22,e.tint),this.audio.brickHit(t,e.hp01),this.cam.shake(.015+t*.02)}brickBreak(e){let t=this.preset.sparks;this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(26*(t/520+.5)),speedMin:6,speedMax:22,lifeMin:.25,lifeMax:.7,sizeMin:5,sizeMax:15,color:e.tint,color2:16777215,kind:1,drag:2.6,grav:-12,jitter:.7}),this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(14*(t/520+.5)),speedMin:4,speedMax:15,lifeMin:.6,lifeMax:1.4,sizeMin:7,sizeMax:16,color:9414333,color2:e.tint,kind:2,drag:1.1,grav:-17,jitter:1}),this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(8*(t/520+.5)),speedMin:1,speedMax:6,lifeMin:.5,lifeMax:1.1,sizeMin:10,sizeMax:22,color:e.tint,color2:16751178,kind:0,drag:1.8,grav:-2}),this.rings.spawn(e.x,F.playY-.85,e.z,.3,5.5,.55,e.tint),this.arena.shock(e.x,e.z,.85,e.tint),this.audio.brickBreak(e.maxHp),this.cam.shake(.075),e.by===0&&this.cam.punch(.9)}salvagePoint(e){let t=I[e.index],n=e.worldPos(new O);this.sparks.burst({at:[n.x,n.y,n.z],dir:[-e.nx,.9,-e.nz],spread:.9,count:Math.round(22*(this.preset.sparks/520+.4)),speedMin:5,speedMax:17,lifeMin:.35,lifeMax:.9,sizeMin:5,sizeMax:13,color:16777215,color2:t.color,kind:1,drag:2.4,grav:-3,jitter:.8}),this.rings.spawn(n.x,F.playY-.8,n.z,.4,7,.6,t.color),this.arena.shock(n.x,n.z,1.1,t.color),this.audio.salvage(),e.index===0&&(this.flash=.16,this.flashColor.set(t.color).convertSRGBToLinear().lerp(new k(1,1,1),.6),this.cam.punch(1.4))}brickSurface(e){let t=this.preset.sparks;this.sparks.burst({at:[e.x,F.floorY+.1,e.z],dir:[0,1,0],spread:.9,count:Math.round(9*(t/520+.4)),speedMin:2,speedMax:9,lifeMin:.25,lifeMax:.6,sizeMin:4,sizeMax:11,color:9431295,color2:16777215,kind:1,drag:2.8,grav:-6,jitter:.5}),this.rings.spawn(e.x,F.playY-.85,e.z,.2,3.4,.5,9431295),this.arena.shock(e.x,e.z,.5,9431295),this.audio.brickSurface()}pinballWarn(e){for(let t of e.bumpers)this.rings.spawn(t.x,F.playY-.86,t.z,2.6,.4,tn,Y),this.arena.shock(t.x,t.z,.45,Y);this.audio.pinballWarn()}pinballDeploy(e){let t=this.preset.sparks;for(let n of e.bumpers)this.sparks.burst({at:[n.x,F.floorY+.1,n.z],dir:[0,1,0],spread:.55,count:Math.round(14*(t/520+.4)),speedMin:5,speedMax:16,lifeMin:.2,lifeMax:.6,sizeMin:5,sizeMax:13,color:16777215,color2:Y,kind:1,drag:3,grav:-8,jitter:.5}),this.rings.spawn(n.x,F.playY-.85,n.z,.3,4.6,.55,Y),this.arena.shock(n.x,n.z,.9,Y);for(let t of e.slings)this.arena.shock(t.x,t.z,.7,Y);this.flash=.18,this.flashColor.set(16767392).convertSRGBToLinear(),this.audio.pinballDeploy(),this.cam.shake(.3),this.cam.punch(2.2)}pinballRetract(e){for(let t of e.bumpers)this.rings.spawn(t.x,F.playY-.85,t.z,3.2,.3,.45,Y),this.arena.shock(t.x,t.z,.4,Y);this.audio.pinballRetract(),this.cam.shake(.1)}bumper(e){let t=U((e.speed-15)/18,0,1);this.sparks.burst({at:[e.x,F.playY,e.z],dir:[e.nx,.6,e.nz],spread:.8,count:Math.round(W(10,20,t)*(this.preset.sparks/520+.4)),speedMin:7,speedMax:20+t*10,lifeMin:.14,lifeMax:.42,sizeMin:5,sizeMax:13,color:16777215,color2:Y,kind:1,drag:3.4,grav:-7,jitter:.5}),this.rings.spawn(e.x,F.playY,e.z,.2,3,.36,Y,0,Math.atan2(e.nx,e.nz)),this.rings.spawn(e.x,F.playY-.8,e.z,.2,3.6,.42,Y),this.arena.shock(e.x,e.z,.6,Y),this.audio.bumper(t),this.cam.shake(.05+t*.04)}sling(e){let t=this.preset.sparks;this.sparks.burst({at:[e.x,F.playY,e.z],dir:[e.nx,.4,e.nz],spread:.42,count:Math.round(24*(t/520+.4)),speedMin:12,speedMax:34,lifeMin:.16,lifeMax:.5,sizeMin:5,sizeMax:15,color:16777215,color2:Y,kind:1,drag:2.4,grav:-6,jitter:.3}),this.sparks.burst({at:[e.x,F.playY,e.z],spread:2,count:Math.round(6*(t/520+.4)),speedMin:1,speedMax:5,lifeMin:.4,lifeMax:1,sizeMin:9,sizeMax:20,color:Y,color2:16767392,kind:0,drag:2,grav:-1.2}),this.rings.spawn(e.x,F.playY,e.z,.3,5,.42,16769200,0,Math.atan2(e.nx,e.nz)),this.arena.shock(e.x,e.z,1,Y),this.audio.sling(),this.cam.shake(.11),this.cam.kick(e.nx,e.nz,.14)}surge(e){let t=e.worldPos(new O),n=I[e.index];this.sparks.burst({at:[t.x,t.y,t.z],dir:[-e.nx,.2,-e.nz],spread:.5,count:Math.round(18*(this.preset.sparks/520+.4)),speedMin:6,speedMax:20,lifeMin:.2,lifeMax:.5,sizeMin:5,sizeMax:12,color:16777215,color2:n.color,kind:1,drag:3,grav:-4,jitter:1.4}),this.rings.spawn(t.x,F.playY-.8,t.z,.4,5.5,.5,16777215),this.audio.surge(),e.index===0&&this.cam.punch(1.6)}serveCharge(e){if(this.arena.setCharge(e),e>.02&&Math.random()<e*.5){let t=K(0,Math.PI*2),n=W(11,1.2,e);this.sparks.burst({at:[Math.cos(t)*n,F.playY,Math.sin(t)*n],dir:[-Math.cos(t),.1,-Math.sin(t)],spread:.25,count:2,speedMin:8,speedMax:18,lifeMin:.2,lifeMax:.45,sizeMin:4,sizeMax:9,color:10481663,color2:16777215,kind:1,drag:1.2,grav:0})}}serveBurst(e,t,n){this.sparks.burst({at:[e,F.playY,t],dir:[Math.sin(n),.2,Math.cos(n)],spread:.7,count:Math.round(26*(this.preset.sparks/520+.4)),speedMin:8,speedMax:24,lifeMin:.2,lifeMax:.55,sizeMin:5,sizeMax:14,color:9431295,color2:16777215,kind:1,drag:2.6,grav:-4}),this.rings.spawn(e,F.playY-.8,t,.3,8,.6,9431295),this.arena.shock(e,t,.8,9431295),this.cam.shake(.14),this.cam.punch(2)}clear(){this.sparks.clear()}dispose(){this.sparks.dispose(),this.rings.dispose()}},an=4,on=0,sn=1,cn=2,ln=3,un=4,dn=`
...
`,pn=class{constructor(e,t){this.scene=e,this.preset=t,this.count=V.perQuadrant*an,this.bricks=[],this.liveCount=0,this.spawned=0,this.justSpawned=[];let{w:r,d:i,h:a}=V;this.geo=qt(r,i,a,V.bevel),this.auraGeo=qt(r+.16,i+.16,a+.1,V.bevel),this.state=new Float32Array(this.count*3),this.tint=new Float32Array(this.count*3),this._attrs=[],this.shell=this._buildShell(),this.aura=this._buildAura(),e.add(this.shell,this.aura),this._m=new oe,this._q=new n,this._pos=new O,this._scl=new O,this._col=new k}_attr(e,t,n,r){let i=new b(n,r);return i.setUsage(C),e.setAttribute(t,i),this._attrs.push(i),i}_buildShell(){this._attr(this.geo,`aState`,this.state,3),this._attr(this.geo,`aTint`,this.tint,3);let e=new g({color:1252135,metalness:.9,roughness:.34,envMapIntensity:.85}),t=new O(V.w,V.h,V.d);e.onBeforeCompile=e=>{e.uniforms.uDim={value:t},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
          ...
          ${dn}`).replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
          {
        ...
        }`});this.auraMat=e;let t=new a(this.auraGeo,e,this.count);return t.name=`bricks:aura`,t.frustumCulled=!1,t.renderOrder=6,t.instanceMatrix.setUsage(C),t}reset(e=[]){let t=[],{w:n,d:r,innerR:i,outerR:a,minGap:o,wellClear:s}=V,c=n=>{let r=Math.hypot(Math.abs(n.x)+n.hw,Math.abs(n.z)+n.hd),c=Math.max(0,Math.abs(n.x)-n.hw),l=Math.max(0,Math.abs(n.z)-n.hd);if(r>a||Math.hypot(c,l)<i)return!1;for(let t of e){let e=U(t.x-n.x,-n.hw,n.hw),r=U(t.z-n.z,-n.hd,n.hd);if(Math.hypot(t.x-n.x-e,t.z-n.z-r)<t.r+s)return!1}for(let e of t)if(Math.abs(n.x-e.x)<n.hw+e.hw+o&&Math.abs(n.z-e.z)<n.hd+e.hd+o)return!1;return!0},l=0;for(let e=0;e<6e3&&l<V.perQuadrant;e++){let e=K(0,Math.PI*.5),o=Math.sqrt(K(i*i,a*a)),s=Math.random()<.5,u=[],d=Math.cos(e)*o,f=Math.sin(e)*o,p=(s?r:n)*.5,m=(s?n:r)*.5,h=!0;for(let e=0;e<an;e++){let e={x:d,z:f,hw:p,hd:m,rot:p<m?Math.PI/2:0};if(!c(e)){h=!1;break}u.push(e);let t=-f;f=d,d=t;let n=m;m=p,p=n}if(h){for(let e of u)t.push({...e,group:l});l++}}this.spawned=0,this.justSpawned=[],this.bricks=t.map((e,t)=>{let n=Math.hypot(e.x,e.z)<V.hpSplit?V.hpInner:V.hpOuter;return{i:t,x:e.x,z:e.z,hw:e.hw,hd:e.hd,rot:e.rot,group:e.group,hp:n,maxHp:n,phase:un,timer:0,anim:0,flash:0,spin:0,seed:Math.random(),by:-1}});for(let e=this.bricks.length;e<this.count;e++)this._writeInstance(e,0,0,0,0,0),this.state[e*3]=0,this.state[e*3+1]=0,this.state[e*3+2]=0;for(let e of this.bricks)this._tint(e,-1);this.liveCount=0,this._sync()}_surface(e){let t=this.bricks[e];!t||t.phase!==un||(t.phase=ln,t.anim=0,t.flash=.85,this.justSpawned.push(t))}_tint(e,t){e.by=t,this._col.set(t>=0?I[t].color:5232383).convertSRGBToLinear();let n=e.i*3;this.tint[n]=this._col.r,this.tint[n+1]=this._col.g,this.tint[n+2]=this._col.b}collide(e,t){let n=B.radius;for(let r of this.bricks){if(r.phase!==on)continue;let i=e.x-r.x,a=e.z-r.z;if(Math.abs(i)>r.hw+n||Math.abs(a)>r.hd+n)continue;let o=U(i,-r.hw,r.hw),s=U(a,-r.hd,r.hd),c=i-o,l=a-s,u=c*c+l*l,d,f,p;if(u>1e-8){if(u>n*n)continue;let e=Math.sqrt(u);d=c/e,f=l/e,p=n-e+.02}else{let e=r.hw-Math.abs(i),t=r.hd-Math.abs(a);e<t?(d=Math.sign(i)||1,f=0,p=e+n+.02):(d=0,f=Math.sign(a)||1,p=t+n+.02)}let m=e.vx*d+e.vz*f;m<0&&(e.vx-=2*m*d,e.vz-=2*m*f),e.x+=d*p,e.z+=f*p;let h=Math.max(B.baseSpeed*.72,Math.hypot(e.vx,e.vz)-V.slow),g=Math.hypot(e.vx,e.vz)||1;e.vx=e.vx/g*h,e.vz=e.vz/g*h,e.speed=h,e.registerImpact(-d,-f,.7);let _=e.lastHitBy;return this._tint(r,_),r.flash=1,r.hp--,r.hp<=0?(r.phase=sn,r.anim=0,r.spin=K(-1,1)*3.4,this.liveCount--,t.push({type:`brickbreak`,x:r.x,z:r.z,nx:d,nz:f,by:_,speed:h,tint:_>=0?I[_].color:5232383,maxHp:r.maxHp})):t.push({type:`brickhit`,x:e.x,z:e.z,nx:d,nz:f,by:_,speed:h,tint:_>=0?I[_].color:5232383,hp01:r.hp/r.maxHp}),!0}return!1}update(e,t=0){this.justSpawned.length=0;let n=Math.floor((t-V.spawnFirst)/V.spawnEvery)+1;for(;this.spawned<this.bricks.length&&this.spawned<n;)this._surface(this.spawned++);for(let t of this.bricks)switch(t.flash=Math.max(0,t.flash-e*4.4),t.phase){case sn:t.anim+=e/V.breakTime,t.anim>=1&&(t.phase=cn,t.timer=V.regen);break;case cn:t.timer-=e,t.timer<=0&&(t.phase=ln,t.anim=0,t.flash=.85);break;case ln:t.anim+=e/V.reformTime,t.anim>=1&&(t.phase=on,t.hp=t.maxHp,t.anim=0,this._tint(t,-1),this.liveCount++)}this._sync()}_sync(){for(let e of this.bricks){let t=1,n=1,r=0,i=0,a=e.hp/e.maxHp;if(e.phase===sn){let o=e.anim,s=o<.22?1+o*.9:Math.max(0,1.2-(o-.22)*1.54);t=s,n=s*(1-o*.55),r=e.spin*o*o,i=o*o*.6,a=0}else if(e.phase===cn||e.phase===un)t=0,n=0;else if(e.phase===ln){let r=e.anim,o=1-(1-r)**3;t=o*(1+Math.sin(r*Math.PI)*.14),n=o,i=-(1-o)*V.h,a=1}let o=e.i*3;this.state[o]=a,this.state[o+1]=Math.min(1,e.flash),this.state[o+2]=e.seed,this._writeInstance(e.i,e.x,e.z,e.rot+r,t,n,i)}this.shell.instanceMatrix.needsUpdate=!0,this.aura.instanceMatrix.needsUpdate=!0;for(let e of this._attrs)e.needsUpdate=!0}_writeInstance(e,t,n,r,i,a,o=0){this._pos.set(t,F.floorY+o,n),this._q.setFromAxisAngle(mn,r),this._scl.set(i,a,i),this._m.compose(this._pos,this._q,this._scl),this.shell.setMatrixAt(e,this._m),this.aura.setMatrixAt(e,this._m)}dispose(){this.geo.dispose(),this.auraGeo.dispose(),this.shellMat.dispose(),this.auraMat.dispose(),this.scene.remove(this.shell,this.aura)}},mn=new O(0,1,0),hn=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
